...
/**
 *<B>Title:</B> Test GetPutRemoveUserObject
 *<BR>
 *<B>Keywords:</B> getUserObject putUserObject removeUserObject
 *<BR>
 *<B>Assertion IDs:</B> A12.11-1 
 *<BR>
...
public class GetPutRemoveUserObject extends JDO_Test {
    ...
    public void testGetNonexistentKey() {
        ...
        assertNull(ASSERTION_FAILED + 
                "Non-null value returned from key that does not exist.",
    ...
    public void testPutKey() {
        ...
        assertNull(ASSERTION_FAILED +
                "putUserObject expected null on first put" + 
                "; actual: " + obj1pv,
                obj1pv);
        assertSame(ASSERTION_FAILED +
                "putUserObject expected replaced object returned: " + obj1p + 
                "; actual: " + obj1rv,
                obj1p, obj1rv);
        assertNull(ASSERTION_FAILED +
                "putUserObject expected null on first put" + 
                ...
                obj2pv);
        assertSame(ASSERTION_FAILED +
                "putUserObject expected replaced object returned: " + obj2p + 
                "; actual: " + obj2rv,
                obj2p, obj2rv);
    }
    ...
    public void testGetKey() {
        ...
        assertNull(ASSERTION_FAILED +
                "putUserObject expected null" + 
                "; actual: " + obj1pv,
                obj1pv);
        assertSame(ASSERTION_FAILED +
                "getUserObject expected: " + obj1p + 
                "; actual: " + obj1g,
                obj1p, obj1g);
        assertNull(ASSERTION_FAILED +
                "putUserObject expected null" + 
    ...
    public void testRemoveKey() {
        ...
        assertSame(ASSERTION_FAILED +
                "removeUserObject(KEY1) expected: " + obj1p + 
                "; actual: " + obj1r,
                obj1p, obj1r);
        assertNull(ASSERTION_FAILED +
                "getUserObject(KEY1) expected null: " + 
                "; actual: " + obj1rr,
                obj1rr);
        assertSame(ASSERTION_FAILED +
                "removeUserObject(KEY2) returned: " + obj2p + 
                "; actual: " + obj2r,
                obj2p, obj2r);
        assertNull(ASSERTION_FAILED +
                "getUserObject(KEY2) expected null: " + 
                "; actual: " + obj2rr,
                obj2rr);
    }
