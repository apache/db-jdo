...
/**
 *<B>Title:</B> Same Transaction Instance For All Calls To Current Transaction
 *<BR>
 *<B>Keywords:</B> 
 *<BR>
 *<B>Assertion ID:</B> A12.5.2-2.
 *<BR>
 *<B>Assertion Description: </B>
The identical <code>Transaction</code> instance will be returned by all
<code>currentTransaction</code> calls to the same <code>PersistenceManager</code>
    ...
    public void test() {
        ...
        if (tx1 != tx2) {
            fail(ASSERTION_FAILED,
                 "tx1 before begin different from tx2 after begin");
        }
        if (tx2 != tx3) {
            fail(ASSERTION_FAILED,
                 "tx2 after begin different from tx3 after commit");
        }
