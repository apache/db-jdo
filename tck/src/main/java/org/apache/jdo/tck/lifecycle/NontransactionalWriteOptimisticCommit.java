 ...
 * <B>Keywords:</B> NontransactionalWrite optimistic commit <br>
 ...
 * RestoreValues flag. ]
 */
public class NontransactionalWriteOptimisticCommit extends NontransactionalWriteTest {
  ...
  public void testOptimisticCommit() {
    ...
    checkXValue(ASSERTION_FAILED + "after optimistic commit", NEW_XVALUE);
    failOnError();
  }
}
