...
/**
 * <B>Title:</B> Is Transactional For Null <br>
 * <B>Keywords:</B> jdohelper <br>
 * <B>Assertion ID:</B> A8.4.2-5 <br>
 * <B>Assertion Description: </B> The jdohelper.isTransactional method returns false, if the
 * instance is null.
 */
/*
 * Revision History
...
public class IsTransactionalForNull extends JDO_Test {
  ...
  public void testIsTransactionalForNull() {
    ...
    tx.commit();
    if (transactional)
      fail(ASSERTION_FAILED, "JDOHelper.isTransactional with argument null returns true.");
    pm.close();
    pm = null;
  }
}
