...
public class JPAAppPerson implements IPerson, Serializable, Comparable, Comparator, DeepEquality {
  ...
  @MapKey(name = "type")
  private Map<String, JPAAppPhoneNumber> phoneNumbers = new HashMap<String, JPAAppPhoneNumber>();
  ...
  protected String getFieldRepr() {
    ...
    rc.append(", born ").append(birthdate == null ? "null" : formatter.format(birthdate));
