...
/**
 * <B>Title:</B> Variable Declared with Same Name as Field of Candidate Class <br>
 * <B>Keywords:</B> query <br>
 * <B>Assertion ID:</B> A14.4-3. <br>
 * <B>Assertion Description: </B> A field of the candidate class of a <code>Query</code> can be
 * hidden if a variable is declared with the same name.
 */
