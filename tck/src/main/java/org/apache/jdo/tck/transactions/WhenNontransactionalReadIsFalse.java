...
/**
 * <B>Title:</B> When Nontransactional Read Is False <br>
 * <B>Keywords:</B> transactions <br>
 * <B>Assertion ID:</B> A13.4.2-10. <br>
 * <B>Assertion Description: </B> If this flag is set to false, then queries and field read access
 * (including navigation) outside an active transaction throw a JDOUserException.
 */
  ...
  public void runTestWhenNontransactionalReadIsFalse(PersistenceManager pm) {
    ...
    try {
      ...
      try {
        ...
        if (debug) logger.debug(" Caught expected JDOUserException " + juex);
      }
      try {
