 ...
 * <B>Assertion ID:</B> A14.6.2-23. <br>
 * <B>Assertion Description: </B> The conditional OR operator (<code>||</code>) is supported for all
...
public class ConditionalOR extends QueryTest {
  ...
  public void testPositive() {
    ...
    Collection instancesLess3 = (Collection) pm.newQuery(PrimitiveTypes.class, "id < 3").execute();
