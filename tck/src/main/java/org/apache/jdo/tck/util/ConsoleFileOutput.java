...
/**
 * Creates an output stream that delegates to {@link System#out} and to a file output stream. The
 * file name of the file output stream is determined by method {@link
 * BatchTestRunner#getFileName()}.
 */
