...
/**
 * <B>Title:</B> Unary Addition Query Operator <br>
 * <B>Keywords:</B> query <br>
 * <B>Assertion ID:</B> A14.6.2-25. <br>
 * <B>Assertion Description: </B> The unary addition operator (<code>+</code>) is supported for all
 ...
 * Short, Integer, Long, Float</code>, and <code>Double</code>), and numeric types (<code>
 * BigDecimal and BigInteger</code>) use the wrapped values as operands.
 */
public class UnaryPlus extends QueryTest {

  /** */
  private static final String ASSERTION_FAILED = "Assertion A14.6.2-25 (UnaryPlus) failed: ";
