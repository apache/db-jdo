...
public class InstanceLifecycleListenerCreate extends AbstractInstanceLifecycleListener {
  ...
  InstanceLifecycleListenerImpl listener = new InstanceLifecycleListenerCreateImpl();
  ...
  public void testCreate() {
    ...
    listener.verifyCallbacks(ASSERTION1_FAILED, new int[] {listener.POST_CREATE_LISTENER});
  }
