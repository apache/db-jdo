...
/**
 * <B>Title:</B> Is Transactional <br>
 * <B>Keywords:</B> jdohelper <br>
 * <B>Assertion ID:</B> A8.4.2-1 <br>
 * <B>Assertion Description: </B> The jdohelper.isTransactional method returns true and delegates to
 * the parameter instance and instances whose state is associated with the current transaction .
...
public class IsTransactional extends JDO_Test {
  ...
  /** */
  private static final String ASSERTION_FAILED = "Assertion A8.4.2-1 (IsTransactional) failed: ";
  ...
  public void testIsTransactional() {
    ...
    tx.commit();
    if (!transactional)
      fail(ASSERTION_FAILED, "JDOHelper.isTransactional returns false for P-NEW instance");
