...
/**
 * <B>Title:</B>GetPMFByStream of PersistenceManagerFactory <br>
 * <B>Keywords:</B> persistencemanagerfactory <br>
 * <B>Assertion IDs:</B> A8.6-17. <br>
...
public class GetPMFByStream extends AbstractGetPMF {
  ...
  /** */
  private static final String ASSERTION_FAILED = "Assertion A8.6-17 (GetPMFByStream) failed: ";
