...
/**
 * <B>Title:</B> Make Dirty Not Persistence Capable <br>
 * <B>Keywords:</B> jdohelper <br>
 * <B>Assertion ID:</B> A8.2-4 <br>
...
public class MakeDirtyNotPersistenceCapable extends JDO_Test {
  ...
  public void testMakeDirtyNotPersistenceCapable() {
    ...
    if (dirty)
      fail(
          ASSERTION_FAILED, "instance of non-pc class is dirty after calling JDOHelper.makeDirty.");
    pm.close();
    pm = null;
  }
}
