...
/**
 * <B>Title:</B> Get Transactional Object Id For Transient <br>
 * <B>Keywords:</B> jdohelper <br>
 * <B>Assertion ID:</B> A8.3-6 <br>
 * <B>Assertion Description: </B> The jdohelper.getTransactionalObjectIdForTransient method returns
 * null if Object is a transient.Evaluating to true when == is used.
 */
...
public class GetTransactionalObjectIdForTransient extends JDO_Test {
  ...
  public void testGetTransactionalObjectIdForTransient() {
    ...
    if (oid != null)
      fail(
          ASSERTION_FAILED,
          "JDOHelper.getTransactionalObjectId called for transiewt instance returned non-null oid "
              + oid);
    pm.close();
    pm = null;
  }
