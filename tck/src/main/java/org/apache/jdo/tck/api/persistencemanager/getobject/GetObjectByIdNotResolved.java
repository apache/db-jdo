 ...
 * <B>Assertion IDs:</B> A12.5.6-1 <br>
 * <B>Assertion Description: </B> In a call to PersistenceManager.getObjectById, if the
 * PersistenceManager is unable to resolve the oid parameter to an ObjectId instance, then it throws
 * a JDOUserException.
 */
