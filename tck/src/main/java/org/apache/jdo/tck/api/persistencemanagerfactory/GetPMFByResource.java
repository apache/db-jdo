...
/**
 * <B>Title:</B>GetPMFByResource of PersistenceManagerFactory <br>
 * <B>Keywords:</B> persistencemanagerfactory <br>
 * <B>Assertion IDs:</B> A8.6-15. <br>
...
public class GetPMFByResource extends AbstractGetPMF {
  ...
  /** */
  private static final String ASSERTION_FAILED = "Assertion A8.6-15 (GetPMFByResource) failed: ";
