...
public class InstanceLifecycleListenerLoad extends AbstractInstanceLifecycleListener {
  ...
  InstanceLifecycleListenerImpl listener = new InstanceLifecycleListenerLoadImpl();
  ...
  public void testLoad() {
    ...
    listener.verifyCallbacks(
        ASSERTION2_FAILED, new int[] {listener.POST_LOAD_CALLBACK, listener.POST_LOAD_LISTENER});
  }
