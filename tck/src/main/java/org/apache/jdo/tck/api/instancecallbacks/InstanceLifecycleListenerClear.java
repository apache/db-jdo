...
public class InstanceLifecycleListenerClear extends AbstractInstanceLifecycleListener {
  ...
  InstanceLifecycleListenerImpl listener = new InstanceLifecycleListenerClearImpl();
  ...
  public void testClear() {
    ...
    listener.verifyCallbacks(
        ASSERTION5_FAILED,
        new int[] {
          listener.PRE_CLEAR_LISTENER, listener.PRE_CLEAR_CALLBACK, listener.POST_CLEAR_LISTENER
        });
  }
