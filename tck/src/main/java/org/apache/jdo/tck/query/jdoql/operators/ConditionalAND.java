...
/**
 * <B>Title:</B> Conditional AND Query Operator <br>
 * <B>Keywords:</B> query <br>
 * <B>Assertion ID:</B> A14.6.2-21. <br>
 * <B>Assertion Description: </B> The conditional AND operator (<code>&amp;&amp;</code>) is
...
public class ConditionalAND extends QueryTest {
  ...
  /** */
  private static final String ASSERTION_FAILED = "Assertion A14.6.2-21 (ConditionalAND) failed: ";
  ...
  public void testPositive() {
    ...
    Collection allOddInstances =
        (Collection) pm.newQuery(PrimitiveTypes.class, "booleanNull").execute();
