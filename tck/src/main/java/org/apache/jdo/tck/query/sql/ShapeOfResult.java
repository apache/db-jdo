...
public class ShapeOfResult extends QueryTest {
  ...
  private Object[] expectedResult = {
    ...
    // single column
    Arrays.asList(new Object[] {"emp1First", "emp2First", "emp3First", "emp4First", "emp5First"}),
    // single column, unique
    "emp1First",
    // mutiple columns
    Arrays.asList(
  ...
  public void testNegative() {
    if (isSQLSupported()) {
      ...
      String sql =
          MessageFormat.format("SELECT stringNull FROM {0}.PrimitiveTypes", new Object[] {schema});
