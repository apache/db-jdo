 ...
 * <B>Assertion ID:</B> A14.6.3-1. <br>
 * <B>Assertion Description: </B> If a parameter type is specified as a primitive, the parameter
 * value passed to execute() must not be null or a JDOUserException is thrown.
 */
