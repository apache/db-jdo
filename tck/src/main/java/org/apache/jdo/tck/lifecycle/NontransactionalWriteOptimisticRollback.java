...
/**
 * <B>Title:</B> Test NontransactionalWriteOptimisticRollback <br>
 * <B>Keywords:</B> NontransactionalWrite optimistic rollback <br>
 ...
 * RestoreValues flag. ]
 */
public class NontransactionalWriteOptimisticRollback extends NontransactionalWriteTest {
  ...
  /**
   * Create a nontransactional dirty instance, begin and rollback a transaction, and check that the
   * instance in the datastore has not been changed.
   */
  public void testOptimisticRollback() {
    ...
    checkXValue(ASSERTION_FAILED + "after optimistic rollback", ORIGINAL_XVALUE);
    failOnError();
  }
}
