...
/**
 * <B>Title:</B> Is Persistent Not Persistence Capable <br>
 * <B>Keywords:</B> jdohelper <br>
 * <B>Assertion ID:</B> A8.4.3-4 <br>
 * <B>Assertion Description: </B> The jdohelper.isPersistent method returns false If the instance
 * does not implement PersistenceCapable evaluating to true when == is used.
 */
/*
 * Revision History
 * ================
...
public class IsPersistentNotPersistenceCapable extends JDO_Test {
  ...
  public void testIsPersistentNotPersistenceCapable() {
    ...
    tx.commit();
    if (persistent)
      fail(ASSERTION_FAILED, "JDOHelper.isPersistent returns false for instance of non-pc class.");
    pm.close();
    pm = null;
  }
}
