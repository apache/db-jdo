 ...
 * <B>Assertion Description: </B> The method "saveAsNamedQuery" allows a query to be saved as a
 * named query for later execution.
 */
public class SaveAsNamedQuery extends QueryTest {

  /** */
  private static final String ASSERTION_FAILED = "Assertion A14.6-22 (SaveAsNamedQuery) failed: ";
  ...
  public void testSave() {
    ...
    executeJDOQuery(
        ASSERTION_FAILED, namedQuery, singleStringQuery, false, null, expectedResult[index], true);
    namedQuery.closeAll();
  }
