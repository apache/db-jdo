...
/**
 * <B>Title:</B> Set Grouping. <br>
 * <B>Keywords:</B> query <br>
 * <B>Assertion ID:</B> A14.6-17. <br>
 * <B>Assertion Description: </B> void setGrouping (String grouping); Specify the grouping of
 * results for aggregates.
 */
public class SetGrouping extends QueryTest {

  /** */
  private static final String ASSERTION_FAILED = "Assertion A14.6-17 (SetGrouping) failed: ";

  /** The expected results of valid queries. */
  private Object[] expectedResult = {
    Arrays.asList(new Object[] {"emp1Last", "emp2Last", "emp3Last", "emp4Last", "emp5Last"})
  };
