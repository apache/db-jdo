 ...
 * <B>Assertion ID:</B> A6.4.3-30. <br>
 * <B>Assertion Description: </B> JDO implementations must support fields of <code>
 * PersistenceCapable</code> class types as First Class Objects.
 */
  ...
  private void checkValues(Object oid, SimpleClass startValue) {
    ...
    for (i = 0; i < n; ++i) {
      ...
      if (!val.equals(startValue)) {
        fail(ASSERTION_FAILED, "Incorrect value for " + FieldsOfSimpleClass.fieldSpecs[i]);
      }
    }
  }
}
