...
/**
 * <B>Title:</B> Support of field type Long. <br>
 * <B>Keywords:</B> model <br>
 * <B>Assertion ID:</B> A6.4.3-14. <br>
 * <B>Assertion Description: </B> JDO implementations must support fields of the immutable object
 * class <code>java.lang.Long</code>, and may choose to support them as Second Class Objects or
 * First Class Objects.
 */
public class TestFieldsOfLong extends JDO_Test {

  /** */
  private static final String ASSERTION_FAILED = "Assertion A6.4.3-14 (TestFieldsOfLong) failed: ";
