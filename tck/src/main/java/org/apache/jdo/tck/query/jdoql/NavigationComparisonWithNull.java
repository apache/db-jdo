...
public class NavigationComparisonWithNull extends QueryTest {
  ...
  public void testPositive0() {
    ...
    Object expected =
        getTransientCompanyModelInstancesAsList(new String[] {"emp0", "emp4", "emp7"});
  ...
  public void testPositive8() {
    ...
    Object expected =
        getTransientCompanyModelInstancesAsList(new String[] {"medicalIns1", "medicalIns5"});
  ...
  public void testPositive9() {
    ...
    Object expected =
        getTransientCompanyModelInstancesAsList(new String[] {"medicalIns2", "medicalIns3"});
