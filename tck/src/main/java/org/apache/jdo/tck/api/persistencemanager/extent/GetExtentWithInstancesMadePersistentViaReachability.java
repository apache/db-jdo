...
public class GetExtentWithInstancesMadePersistentViaReachability extends PersistenceManagerTest {
  ...
  private void runTest(PersistenceManager pm) {
    ...
    for (Iterator i = e.iterator(); i.hasNext(); ) {
      ...
      if (dep.getName().equals("Department 1")) foundDep1 = true;
      else if (dep.getName().equals("Department 2")) foundDep2 = true;
      else if (dep.getName().equals("Department 3")) foundDep3 = true;
    }
