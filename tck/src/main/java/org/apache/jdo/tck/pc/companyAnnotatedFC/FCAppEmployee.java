...
public abstract class FCAppEmployee extends FCAppPerson implements IEmployee {
    ...
    /**
     * Add an <code>FCAppEmployee</code> to this employee's team.
    ...
    /**
     * Remove an <code>FCAppEmployee</code> from this employee's team.
    ...
    /**
     * Add an <code>FCAppEmployee</code> as an advisee of this HR advisor. 
    ...
    /**
     * Remove an <code>FCAppEmployee</code> as an advisee of this HR advisor.
     ...
     * deep equal to the corresponding fields of the specified FCAppEmployee.
     * 
