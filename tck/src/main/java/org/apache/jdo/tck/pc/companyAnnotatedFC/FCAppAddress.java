...
public class FCAppAddress 
     ...
     */
    public FCAppAddress(long addrid, String street, String city, 
    ...
    public int compareTo(Object o) {
        return compareTo((FCAppAddress)o);
    }
    ...
    public int compare(Object o1, Object o2) {
        return compare((FCAppAddress)o1, (FCAppAddress)o2);
    }
     ...
     * object. 
     */
    public int compareTo(FCAppAddress other) {
        return compare(this, other);
    }
    
    /**
     * Compares its two FCAppAddress arguments for order. Returns a negative
     ...
     */
    public static int compare(FCAppAddress o1, FCAppAddress o2) {
