 ...
 * <B>Assertion IDs:</B> A14.5-1. <br>
 * <B>Assertion Description: </B> PersistenceManagerFactory.newQuery() constructs and empty Query
 * instance.
 */
public class NewQueryWithExtent extends QueryTest {

  /** */
  private static final String ASSERTION_FAILED = "Assertion A14.5-1 (NewQueryWithExtent) failed: ";
