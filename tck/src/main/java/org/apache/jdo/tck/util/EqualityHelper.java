...
public class EqualityHelper {
   ...
   */
  private static Comparator entryKeyComparator =
      new Comparator() {
  ...
  private static class DeepEqualityEntryKeyComparator implements Comparator {
  ...
  public boolean deepEquals(Object me, Object other) {
    ...
    if ((me instanceof Map) && (other instanceof Map)) return deepEquals((Map) me, (Map) other);
  ...
  public boolean deepEquals(Collection mine, Collection other) {
    ...
    Comparator comparator = (Comparator) myList.get(0);
  ...
  public boolean deepEquals(Map mine, Map other) {
    ...
    /* Any collection of elements to be compared must implement Comparator
     * to avoid the other side having to implement Comparable. */
    Comparator comparator = (Comparator) ((Map.Entry) myList.get(0)).getKey();
   ...
   *     comparable.
   */
  public boolean deepEquals(Collection me, Collection other, String where) {
    if (me == other) return true;
    if (me == null) {
      logUnequal(me, other, where + msgMeNull);
      return false;
   ...
   * @return <code>true</code> if the collections are deep equal.
   */
  public boolean shallowEquals(Collection me, Collection other, String where) {
    if (me == other) return true;
    if (me == null) {
      logUnequal(me, other, where + msgMeNull);
      return false;
