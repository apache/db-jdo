...
public abstract class PCAppEmployee extends PCAppPerson implements IEmployee {
  ...
  @NotPersistent() private transient Set _reviewedProjects = new HashSet();
  @NotPersistent() private transient Set _projects = new HashSet();
  @NotPersistent() private transient Set _team = new HashSet();
  @NotPersistent() private transient Set _hradvisees = new HashSet();
  ...
  public PCAppEmployee(
      ...
      IAddress address,
      Date hiredate) {
    super(personid, firstname, lastname, middlename, birthdate, (PCAppAddress) address);
    this._hiredate = hiredate;
  }
  ...
  protected String getFieldRepr() {
    ...
    rc.append(", hired ").append(_hiredate == null ? "null" : formatter.format(_hiredate));
