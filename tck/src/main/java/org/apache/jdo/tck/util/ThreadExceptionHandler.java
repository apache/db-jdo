...
/**
 * This class extends java.lang.ThreadGroup and stores any uncaught exception of threads from this
 * ThreadGroup for later retrieval.
 *
 * @author Michael Bouschen
 */
public class ThreadExceptionHandler extends ThreadGroup {
  /**
   * Map of uncaught exceptions. The thread is the key and the uncaught Throwable is the value in
   * the map.
   */
   ...
   * uncaught exception. This implementation stores the uncaught exception in a map for later
   * retrieval.
   */
  ...
  /**
   * Returns all uncaught exceptions stored in this ThreadGroup. Each element in the returned set is
   * a Map.Entry with the thread as the key and the uncaught Throwable is the value.
   *
