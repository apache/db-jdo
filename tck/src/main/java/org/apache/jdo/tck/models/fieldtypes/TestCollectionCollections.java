...
/**
 * <B>Title:</B> Support of field type Collection. <br>
 * <B>Keywords:</B> model <br>
 * <B>Assertion ID:</B> A6.4.3-33. <br>
 * <B>Assertion Description: </B> JDO implementations must support fields of the interface type
 * <code>java.util.Collection</code>, and may choose to support them as Second Class Objects or
 * First Class Objects.
 */
