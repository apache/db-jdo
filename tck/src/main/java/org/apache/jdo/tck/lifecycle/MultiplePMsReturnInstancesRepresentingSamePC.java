...
/**
 * <B>Title:</B> Test that Multiple PMs return different instances representing same PC object <br>
 * <B>Keywords:</B> lifecycle Multiple PMs getObjectById equal <br>
 * <B>Assertion IDs:</B> A5.4-7 <br>
 * <B>Assertion Description: </B> The instance returned by a call to getObjectById(Object) of
 * different PersistenceManager instances returned by the same PersistenceManagerFactory represent
 * the same persistent object, but with different Java object identity (specifically, all instances
 * returned by getObjectId from the instances must return true to equals comparisons with all
 * others).
 */
    ...
    try {
      ...
      for (int i = 0; i < NUM_OBJECTS; i++) {
        ...
        if (!((obj1 != obj2) && (obj1 != obj3))) {
          fail(
              ASSERTION_FAILED,
              "Objects are not different instances. obj1="
                  + obj1
                  + " obj2= "
                  + obj2
                  + " obj3= "
        ...
        if (!(objId1.equals(objId2) && objId1.equals(objId3))) {
          fail(
              ASSERTION_FAILED,
              "Object Ids are not equal. objId1="
                  + objId1
                  + " objId2= "
                  + objId2
                  + " objId3= "
