...
public class PCAppProject implements IProject, Serializable, Comparable, Comparator, DeepEquality {

  @NotPersistent() private long _projid;
  @NotPersistent() private String _name;
  @NotPersistent() private BigDecimal _budget;
  @NotPersistent() private transient Set _reviewers = new HashSet();
  @NotPersistent() private transient Set _members = new HashSet();
