...
/**
 * <B>Title:</B> Binary Subtraction Query Operator <br>
 * <B>Keywords:</B> query <br>
 * <B>Assertion ID:</B> A14.6.2-28. <br>
 * <B>Assertion Description: </B> The binary subtraction operator (<code>-</code>) is supported for
