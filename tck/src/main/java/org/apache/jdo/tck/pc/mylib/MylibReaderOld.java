...
public class MylibReaderOld extends DefaultListableBeanFactory {
   ...
   */
  private MylibReaderOld(String resourceName) {
   ...
   */
  private MylibReaderOld(String resourceName, ClassLoader classLoader) {
    super();
    configureFactory();
