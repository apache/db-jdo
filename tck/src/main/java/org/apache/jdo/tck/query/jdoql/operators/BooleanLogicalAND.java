...
/**
 * <B>Title:</B> Boolean Logical AND Query Operator <br>
 * <B>Keywords:</B> query <br>
 * <B>Assertion ID:</B> A14.6.2-20. <br>
 * <B>Assertion Description: </B> The Boolean logical AND (not bitwise) operator (<code>&amp;</code>
