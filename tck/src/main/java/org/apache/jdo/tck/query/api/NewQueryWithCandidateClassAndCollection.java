...
/**
 * <B>Title:</B> New Query with Candidate Class and Collection <br>
 * <B>Keywords:</B> query extent <br>
 * <B>Assertion ID:</B> A14.5-7. <br>
 * <B>Assertion Description: </B> <code>PersistenceManager.newQuery(Class cls, Collection cln)
 * </code> constructs a query instance with the candidate class and candidate <code>Collection
 * </code> specified.
 */
