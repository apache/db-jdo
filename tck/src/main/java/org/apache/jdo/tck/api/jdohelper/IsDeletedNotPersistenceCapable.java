...
/**
 * <B>Title:</B> Is Deleted Not Persistence Capable <br>
 * <B>Keywords:</B> jdohelper <br>
 * <B>Assertion ID:</B> A8.4.5-4 <br>
 * <B>Assertion Description: </B> The JDOHelper.IsDeleted method returns false if the instance is
 * not persistence capable , evaluating to true when == is used.
 */
