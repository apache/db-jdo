...
public class AbstractFetchPlanTest extends JDO_Test {
  ...
  protected String[] upperLeftGroup = new String[] {"default", "PCRect.upperLeft"};
  protected String[] lowerRightGroup = new String[] {"default", "PCRect.lowerRight"};
  protected String[] bothGroup = new String[] {"default", "PCRect.upperLeft", "PCRect.lowerRight"};
  /**
