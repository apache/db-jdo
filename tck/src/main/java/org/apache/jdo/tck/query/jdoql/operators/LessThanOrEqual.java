...
public class LessThanOrEqual extends ComparisonTests {
    ...
    private void runQueries()
    {
        ...
        run_CharacterQuery(Character_filterL, ShortParameter, new Short((short)'A'), Character.valueOf('A'), true, 8);
        run_CharacterQuery(Character_filterR, ShortParameter, new Short((short)'A'), Character.valueOf('A'), false, 3);
        ...
        run_CharacterQuery(Character_filterL, longParameter, new Long('z'), Character.valueOf('z'), true, 3);
        run_CharacterQuery(Character_filterR, longParameter, new Long('z'), Character.valueOf('z'), false, 9);
        run_CharacterQuery(Character_filterL, LongParameter, new Long('B'), Character.valueOf('B'), true, 7);
        run_CharacterQuery(Character_filterR, LongParameter, new Long('B'), Character.valueOf('B'), false, 4);
        run_CharacterQuery(Character_filterL, floatParameter, new Float('z'), Character.valueOf('z'), true, 3);
        run_CharacterQuery(Character_filterR, floatParameter, new Float('z'), Character.valueOf('z'), false, 9);
        ...
        run_CharacterQuery(Character_filterL, doubleParameter, new Double('B'), Character.valueOf('B'), true, 7);
        run_CharacterQuery(Character_filterR, doubleParameter, new Double('B'), Character.valueOf('B'), false, 4);
        run_CharacterQuery(Character_filterL, DoubleParameter, new Double('A'), Character.valueOf('A'), true, 8);
        run_CharacterQuery(Character_filterR, DoubleParameter, new Double('A'), Character.valueOf('A'), false, 3);
        ...
        run_LongQuery(Long_filterL, charParameter, Character.valueOf((char)0), new Long(0), true, 6);
        run_LongQuery(Long_filterR, charParameter, Character.valueOf((char)100), new Long(100), false, 7);
        ...
        run_FloatQuery(Float_filterL, charParameter, Character.valueOf((char)0), new Float(0.0f), true, 8);
        ...
        run_DoubleQuery(Double_filterR, charParameter, Character.valueOf((char)0), new Double(0.0), false, 4);
