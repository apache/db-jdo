...
public class LessThanOrEqual extends ComparisonTests {
    ...
    private void runQueries()
    {
        ...
        run_ByteQuery(Byte_filterR, IntegerParameter, new Integer(75), Byte.valueOf((byte)75), false, 8);
        ...
        run_IntegerQuery(Integer_filterR, byteParameter, Byte.valueOf((byte)0), new Integer(0), false, 4);
        run_IntegerQuery(Integer_filterL, ByteParameter, Byte.valueOf((byte)100), new Integer(100), true, 6);
        run_IntegerQuery(Integer_filterR, ByteParameter, Byte.valueOf((byte)0), new Integer(0), false, 4);
