...
/**
 * <B>Title:</B> Iterator HasNext returns False after Extent.close <br>
 * <B>Keywords:</B> extent <br>
 * <B>Assertion ID:</B> A15.3-9. <br>
 * <B>Assertion Description: </B> After a call to <code>Extent.close(Iterator i)</code>, the
 * parameter <code>Iterator</code> will return <code>false</code> to <code>hasNext()</code>.
 */
