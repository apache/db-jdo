...
/**
 * <B>Title:</B> Test DetachUndetachable <br>
 * <B>Keywords:</B> detachCopy detach detachable <br>
 * <B>Assertion IDs:</B> A12.6.8-32 <br>
 * <B>Assertion Description: </B> Instances to be detached that are not of a Detachable class are
 * detached as transient instances.
 */
public class DetachUndetachable extends DetachTest {
  ...
  public void testDetachUndetachable() {
    ...
    if (JDOHelper.isPersistent(instance)) {
      appendMessage(
          "testDetachUndetachable: should be transient"
