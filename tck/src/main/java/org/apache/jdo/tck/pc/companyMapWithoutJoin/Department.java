...
public class Department
  ...
  private Map<String, IEmployee> roles;
   ...
   */
  public Department(long deptid, String name, Company company, Map<String, IEmployee> roles) {
    this.deptid = deptid;
    this.name = name;
  ...
  /**
   * Get the roles in the department as an unmodifiable set. ****************** FIX??
   *
   * @return The set of employees in the department, as an unmodifiable set.
   */
  public Map<String, IEmployee> getRoles() {
    return roles;
  }
   ...
   */
  public void addRole(String role, IEmployee emp) {
    roles.put(role, emp);
  }
