...
/**
 * <B>Title:</B> Is Transactional For Transient <br>
 * <B>Keywords:</B> jdohelper <br>
 * <B>Assertion ID:</B> A8.4.2-3 <br>
 * <B>Assertion Description: </B> The jdohelper.isTransactional method returns false if the instance
 * is transien . evaluating to true when == is used.
 */
/*
 * Revision History
 * ================
...
public class IsTransactionalForTransient extends JDO_Test {
  ...
  public void testIsTransactionalForTransient() {
    ...
    tx.commit();
    if (transactional)
      fail(ASSERTION_FAILED, "JDOHelper.isTransactional returns true for transient instance.");
    pm.close();
    pm = null;
  }
}
