...
@Discriminator(
    ...
    indexed = "true")
public class PCAppPerson implements IPerson, Serializable, Comparable, Comparator, DeepEquality {
  ...
  @NotPersistent() private Map _phoneNumbers = new HashMap();
  ...
  protected String getFieldRepr() {
    ...
    rc.append(", born ").append(_birthdate == null ? "null" : formatter.format(_birthdate));
