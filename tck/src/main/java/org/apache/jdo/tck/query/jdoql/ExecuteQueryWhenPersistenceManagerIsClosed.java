...
/**
 * <B>Title:</B> Execute Query when Persistence Manager is Closed <br>
 * <B>Keywords:</B> query <br>
 * <B>Assertion ID:</B> A14.6.1-1. <br>
 * <B>Assertion Description: </B> If the <code>PersistenceManager</code> which constructed the
 * <code>Query</code> is closed, then the <code>Query.execute</code> methods throw <code>
 * JDOFatalUserException</code>.
 */
  ...
  void runTestExecuteQueryWhenPersistenceManagerIsClosed(PersistenceManager pm) {
    ...
    try {
      ...
      try {
        ...
        fail(ASSERTION_FAILED, "Query.execute after pm is closed should throw JDOUserException.");
