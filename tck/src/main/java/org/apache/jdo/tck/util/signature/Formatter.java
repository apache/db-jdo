 ...
 */
class Formatter {
  /** Returns a string formatting an array of names as comma-separated list. */
  ...
  /**
   * Returns a string formatting an array of class objects as comma-separated list of (Java) user
   * type names.
   */
  ...
  /**
   * Returns an exhaustive string description of a <code>Field</code> presenting types as (Java)
   * user type names.
   */
  ...
  public static String toString(int mods, String type, String name, String value) {
    final StringBuffer s = new StringBuffer();
  ...
  /**
   * Returns an exhaustive string description of a <code>Constructor</code> presenting types as
   * (Java) user type names.
   */
  ...
  /**
   * Returns an exhaustive string description of a <code>Method</code> presenting types as (Java)
   * user type names.
   */
  ...
  /** Returns an combined string description of a constructor or method declaration. */
  public static String toString(
      int mods, String result, String name, String[] params, String[] excepts) {
    final StringBuffer s = new StringBuffer();
    s.append(Modifier.toString(mods)).append(" ");
  ...
  /**
   * Returns an exhaustive string description of a <code>Class</code> presenting types as (Java)
   * user type names.
   */
  ...
  public static String toString(int mods, String name, String[] ext, String[] impl) {
    final StringBuffer s = new StringBuffer();
  ...
  /**
   * Returns an exhaustive string description of a <code>Member</code> presenting types as (Java)
   * user type names.
   */
