...
public class FCAppPartTimeEmployee extends FCAppEmployee 
     ...
     */
    public FCAppPartTimeEmployee(long personid, String first, String last,
     ...
     */
    public FCAppPartTimeEmployee(long personid, String first, String last,
                            String middle, Date born, FCAppAddress addr, 
                            Date hired, double wage ) {
