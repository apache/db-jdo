...
public class RelationshipNegative1To1Test extends AbstractRelationshipTest {
  ...
  protected String ASSERTION_FAILED = "Assertion A15-3.14 (RelationshipNegative1To1Test) failed: ";
  ...
  public void testA2BbutNotB2AMappedBy() {
    ...
    if (isTestToBePerformed) {
      IMedicalInsurance medInsNew = new MedicalInsurance(99, "The American Company", "B");
  ...
  protected void doFlush(String method) {
    try {
      pm.flush();
      fail(ASSERTION_FAILED + testMethod + ": expected JDOUserException on flush!");
