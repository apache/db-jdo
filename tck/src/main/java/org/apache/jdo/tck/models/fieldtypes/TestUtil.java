...
public class TestUtil {
  ...
  public static String[] elementTypes =
      new String[] {
        "Object",
        "SimpleClass",
        "SimpleInterface",
  ...
  protected static boolean containsBigDecimalKey(BigDecimal keyValue, Set bigDecimalKeySet) {
  ...
  protected static BigDecimal getBigDecimalKey(BigDecimal keyValue, Set bigDecimalKeySet) {
    Iterator iter = bigDecimalKeySet.iterator();
    while (iter.hasNext()) {
      BigDecimal nextVal = (BigDecimal) iter.next();
      if (keyValue.compareTo(nextVal) == 0) {
