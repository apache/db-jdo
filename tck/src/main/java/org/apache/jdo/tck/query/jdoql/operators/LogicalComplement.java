...
public class LogicalComplement extends QueryTest {
  ...
  public void testPositiveSimpleComplement() {
    ...
    try {
      ...
      Collection allEvenInstances =
          (Collection) pm.newQuery(PrimitiveTypes.class, "booleanNull == false").execute();
      Collection allInstances = (Collection) pm.newQuery(PrimitiveTypes.class, "true").execute();
  ...
  public void testPositiveComplementOfRelationalOp() {
    ...
    try {
      ...
      Collection instancesLess3 =
          (Collection) pm.newQuery(PrimitiveTypes.class, "id < 3").execute();
      Collection instancesNot3 =
          (Collection) pm.newQuery(PrimitiveTypes.class, "id != 3").execute();
      Collection instances3 = (Collection) pm.newQuery(PrimitiveTypes.class, "id == 3").execute();
  ...
  public void testPositiveNullFieldComparison() {
    ...
    try {
      ...
      Collection instances3 = (Collection) pm.newQuery(PrimitiveTypes.class, "id == 3").execute();
      Collection instancesNot0Not3 =
          (Collection) pm.newQuery(PrimitiveTypes.class, "id != 3 && id != 0").execute();
  ...
  public void testPositiveNullCheck() {
    ...
    try {
      ...
      Collection instancesGreater0 =
          (Collection) pm.newQuery(PrimitiveTypes.class, "id > 0").execute();
      Collection instances0 = (Collection) pm.newQuery(PrimitiveTypes.class, "id == 0").execute();
