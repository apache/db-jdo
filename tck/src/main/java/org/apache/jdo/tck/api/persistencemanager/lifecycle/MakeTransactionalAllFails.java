 ...
 * <B>Assertion ID:</B> A12.5.7-4 <br>
 * <B>Assertion Description: </B> If a collection or array of instances is passed to
 * PersistenceManager.makeTransactionalAll, and one or more of the instances fail to complete the
 * required o peration, then all instances will be attempted, and a JDOUserException will be thrown
 * which contains a nested exception array, each exception of which conta ins one of the failing
