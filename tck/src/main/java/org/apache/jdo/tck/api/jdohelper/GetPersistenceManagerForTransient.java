...
/**
 * <B>Title:</B> Get Persistence Manager For Transien <br>
 * <B>Keywords:</B> jdohelper <br>
 * <B>Assertion ID:</B> A8.1-2. <br>
 * <B>Assertion Description: </B> The jdohelper.getPersistenceManager method returns null if object
 * is transient evaluating to true when == is used.
 */
...
public class GetPersistenceManagerForTransient extends JDO_Test {
  ...
  public void testGetPersistenceManagerForTransient() {
    ...
    if (pm1 != null)
      fail(
          ASSERTION_FAILED,
          "JDOHelper.getPersistenceManager called for transient instance returned non-null pm "
              + pm1);
  }
}
