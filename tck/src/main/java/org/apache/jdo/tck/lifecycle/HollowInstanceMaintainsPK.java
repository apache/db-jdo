...
/**
 * <B>Title:</B> Test that Hollow Instances maintains PK <br>
 * <B>Keywords:</B> lifecycle hollow instance PK <br>
 * <B>Assertion IDs:</B> A5.5.4-3 <br>
 * <B>Assertion Description: </B> If the instance is of a class using application identity, the
 * hollow instance maintains its primary key fields.
 */
  ...
  public void test() {
    if (!isApplicationIdentitySupported()) {
      printUnsupportedOptionalFeatureNotTested(
          getClass().getName(), "javax.jdo.option.ApplicationIdentity");
    } else if (!runsWithApplicationIdentity()) {
      printNonApplicableIdentityType(getClass().getName(), "javax.jdo.option.ApplicationIdentity");
    } else {
      pm = getPM();
