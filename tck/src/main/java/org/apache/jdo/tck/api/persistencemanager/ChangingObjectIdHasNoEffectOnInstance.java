 ...
 * <B>Assertion ID:</B> A12.5.6-13. <br>
 * <B>Assertion Description: </B> If the application makes a change to the <code>ObjectId</code>
 * instance returned by <code>PersistenceManager.getObjectId</code>, there is no effect on the
 * instance from which the <code>ObjectId</code> was obtained.
 */
