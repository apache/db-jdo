...
public class TypeHelper {
  ...
  private static final Map userTypeNames = new HashMap();

  /** Maps primitive (Java) user type names to reflection names. */
  private static final Map reflectionTypeNames = new HashMap();
  ...
  static {
    ...
    for (Iterator i = userTypeNames.entrySet().iterator(); i.hasNext(); ) {
