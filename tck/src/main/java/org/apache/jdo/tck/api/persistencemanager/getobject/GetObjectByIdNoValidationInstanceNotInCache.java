 ...
 * <B>Assertion IDs:</B> A12.5.6-5 <br>
 ...
 * with the same JDO identity as the oid parameter, and there is a transaction in progress, then
 * this method creates an instance with the specified JDO identity and returns it with a state of
 * hollow, persistent-nontransactional, or persistent-clean, at the choice of the implementation.
 */
