...
public class FCDSCompany implements ICompany, Serializable, Comparable, Comparator, DeepEquality {
  ...
  protected String getFieldRepr() {
    ...
    rc.append(", founded ").append(founded == null ? "null" : formatter.format(founded));
    return rc.toString();
  }
