 ...
 * <B>Keywords:</B> identity exception <br>
 * <B>Assertion ID:</B> A12.5.6-6. <br>
 * <B>Assertion Description: </B> If <code>PersistenceManager.getObjectById</code> is called with a
 * value of <code>false</code> for the second parameter named <code>validate</code>, and the
 * instance does not exist in the data store, a subsequent access of the fields of the instance will
 * throw a <code>JDODatastoreException</code> if the instance does not exist at that time.
 */
public class GetObjectByIdNoValidationInstanceNotInDatastore extends PersistenceManagerTest {
  ...
  public void testGetObjectByIdNoValidationInstanceNotInDatastore() {
    ...
    try {
      ...
      if (debug) logger.debug("Got object in cache, even though not in datastore.");
    ...
    if (debug) logger.debug("END GetObjectByIdNoValidationInstanceNotInDatastore");
  }
}
