 ...
 * <B>Assertion ID:</B> A8.3-8 <br>
 * <B>Assertion Description: </B> The jdohelper.getTransactionalObjectIdForNull method returns null
 * if Object is null.Evaluating to true when == is used.
 */
/*
 * Revision History
 * ================
