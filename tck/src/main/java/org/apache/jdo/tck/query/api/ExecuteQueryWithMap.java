...
/**
 * <B>Title:</B> Execute Query with Map <br>
 * <B>Keywords:</B> query <br>
 * <B>Assertion ID:</B> A14.6.1-5. <br>
 * <B>Assertion Description: </B> The <code>Query.executeWithMap</code> method is similar to the
 * <code>execute</code> method, but takes its parameters from a <code>Map</code> instance. The
 * <code>Map</code> contains key/value pairs, in which the key is the declared parameter name, and
 * the value is the value to use in the query for that parameter. Unlike <code>execute</code>, there
