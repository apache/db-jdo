 ...
 * <B>Assertion ID:</B> A8.4.1-1 <br>
 * <B>Assertion Description: </B> The jdohelper.isDirty method returns true if the instance of
 * persistence capable have changed the state in the current transaction evaluating to true when ==
 * is used.
 */
/*
 * Revision History
...
public class IsDirty extends JDO_Test {
  ...
  public void testIsDirty() {
    ...
    if (!dirty) fail(ASSERTION_FAILED, "JDOHelper.isDirty returns false for P-NEW instance");
    pm.close();
    pm = null;
  }
}
