...
//    run_longQuery(long_filterR, doubleParameter, new Double((double)Long.MAX_VALUE), Long.MAX_VALUE, 1);
        ...
        run_ShortQuery(Short_filterL, charParameter, Character.valueOf((char)75), new Short((short)75), 0);
        run_ShortQuery(Short_filterR, charParameter, Character.valueOf((char)75), new Short((short)75), 0);
        run_ShortQuery(Short_filterL, CharacterParameter, Character.valueOf((char)100), new Short((short)100), 2);
        run_ShortQuery(Short_filterR, CharacterParameter, Character.valueOf((char)100), new Short((short)100), 2);
        ...
        run_CharacterQuery(Character_filterL, shortParameter, new Short((short)'M'), Character.valueOf('M'), 2);
        run_CharacterQuery(Character_filterR, shortParameter, new Short((short)'F'), Character.valueOf('F'), 1);
        run_CharacterQuery(Character_filterL, ShortParameter, new Short((short)'A'), Character.valueOf('A'), 1);
        run_CharacterQuery(Character_filterR, ShortParameter, new Short((short)'A'), Character.valueOf('A'), 1);
        ...
        run_CharacterQuery(Character_filterL, longParameter, new Long('z'), Character.valueOf('z'), 2);
        run_CharacterQuery(Character_filterR, longParameter, new Long('z'), Character.valueOf('z'), 2);
        run_CharacterQuery(Character_filterL, LongParameter, new Long('B'), Character.valueOf('B'), 1);
        run_CharacterQuery(Character_filterR, LongParameter, new Long('B'), Character.valueOf('B'), 1);
        run_CharacterQuery(Character_filterL, floatParameter, new Float(123.222), Character.valueOf('x'), 0);
        run_CharacterQuery(Character_filterR, floatParameter, new Float(123.222), Character.valueOf('x'), 0);
        run_CharacterQuery(Character_filterL, FloatParameter, new Float('z'), Character.valueOf('z'), 2);
        run_CharacterQuery(Character_filterR, FloatParameter, new Float('z'), Character.valueOf('z'), 2);
        run_CharacterQuery(Character_filterL, doubleParameter, new Double('B'), Character.valueOf('B'), 1);
        run_CharacterQuery(Character_filterR, doubleParameter, new Double('B'), Character.valueOf('B'), 1);
        run_CharacterQuery(Character_filterL, DoubleParameter, new Double('A'), Character.valueOf('A'), 1);
        run_CharacterQuery(Character_filterR, DoubleParameter, new Double('A'), Character.valueOf('A'), 1);
        ...
        run_LongQuery(Long_filterL, charParameter, Character.valueOf((char)0), new Long(0), 1);
        run_LongQuery(Long_filterR, charParameter, Character.valueOf((char)100), new Long(100), 2);
        run_LongQuery(Long_filterL, CharacterParameter, Character.valueOf((char)23), new Long(23), 0);
        run_LongQuery(Long_filterR, CharacterParameter, Character.valueOf((char)0), new Long(0), 1);
...
//    run_LongQuery(Long_filterR, doubleParameter, new Double((double)Long.MAX_VALUE), new Long(Long.MAX_VALUE), 1);
        ...
        run_FloatQuery(Float_filterL, charParameter, Character.valueOf((char)0), new Float(0.0f), 1);
        run_FloatQuery(Float_filterR, charParameter, Character.valueOf((char)23), new Float(23.0f), 0);
        run_FloatQuery(Float_filterL, CharacterParameter, Character.valueOf((char)34), new Float(34.0f), 0);
        run_FloatQuery(Float_filterR, CharacterParameter, Character.valueOf((char)100), new Float(100.0f), 2);
        ...
        run_DoubleQuery(Double_filterL, charParameter, Character.valueOf((char)100), new Double(100.0), 2);
        run_DoubleQuery(Double_filterR, charParameter, Character.valueOf((char)0), new Double(0.0), 1);
        run_DoubleQuery(Double_filterL, CharacterParameter, Character.valueOf((char)23), new Double(23.0), 0);
        run_DoubleQuery(Double_filterR, CharacterParameter, Character.valueOf((char)100), new Double(100.0), 2);
