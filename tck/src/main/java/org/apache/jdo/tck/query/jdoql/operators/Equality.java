...
//    run_longQuery(long_filterR, doubleParameter, Double.valueOf((double)Long.MAX_VALUE), Long.MAX_VALUE, 1);
        ...
        run_ByteQuery(Byte_filterL, shortParameter, Short.valueOf((short)50), new Byte((byte)50), 2);
        run_ByteQuery(Byte_filterR, shortParameter, Short.valueOf((short)50), new Byte((byte)50), 2);
        run_ByteQuery(Byte_filterL, ShortParameter, Short.valueOf((short)-100), new Byte((byte)-100), 1);
        run_ByteQuery(Byte_filterR, ShortParameter, Short.valueOf((short)-100), new Byte((byte)-100), 1);
        run_ByteQuery(Byte_filterL, charParameter, Character.valueOf((char)50), new Byte((byte)50), 2);
        run_ByteQuery(Byte_filterR, charParameter, Character.valueOf((char)50), new Byte((byte)50), 2);
        run_ByteQuery(Byte_filterL, CharacterParameter, Character.valueOf((char)50), new Byte((byte)50), 2);
        run_ByteQuery(Byte_filterR, CharacterParameter, Character.valueOf((char)75), new Byte((byte)75), 1);
        ...
        run_ByteQuery(Byte_filterL, longParameter, Long.valueOf(50), new Byte((byte)50), 2);
        run_ByteQuery(Byte_filterR, longParameter, Long.valueOf(50), new Byte((byte)50), 2);
        run_ByteQuery(Byte_filterL, LongParameter, Long.valueOf(-100), new Byte((byte)-100), 1);
        run_ByteQuery(Byte_filterR, LongParameter, Long.valueOf(-100), new Byte((byte)-100), 1);
        run_ByteQuery(Byte_filterL, floatParameter, Float.valueOf((float)50), new Byte((byte)50), 2);
        run_ByteQuery(Byte_filterR, floatParameter, Float.valueOf((float)50), new Byte((byte)50), 2);
        run_ByteQuery(Byte_filterL, FloatParameter, Float.valueOf((float)-100), new Byte((byte)-100), 1);
        run_ByteQuery(Byte_filterR, FloatParameter, Float.valueOf((float)-100), new Byte((byte)-100), 1);
        run_ByteQuery(Byte_filterL, doubleParameter, Double.valueOf(50), new Byte((byte)50), 2);
        run_ByteQuery(Byte_filterR, doubleParameter, Double.valueOf(50), new Byte((byte)50), 2);
        run_ByteQuery(Byte_filterL, DoubleParameter, Double.valueOf(-100), new Byte((byte)-100), 1);
        run_ByteQuery(Byte_filterR, DoubleParameter, Double.valueOf(-100), new Byte((byte)-100), 1);
        ...
        run_ShortQuery(Short_filterL, byteParameter, new Byte((byte)75), Short.valueOf((short)75), 0);
        run_ShortQuery(Short_filterR, byteParameter, new Byte((byte)75), Short.valueOf((short)75), 0);
        run_ShortQuery(Short_filterL, ByteParameter, new Byte((byte)100), Short.valueOf((short)100), 2);
        run_ShortQuery(Short_filterR, ByteParameter, new Byte((byte)100), Short.valueOf((short)100), 2);
        ...
        run_ShortQuery(Short_filterL, intParameter, new Integer(-10000), Short.valueOf((short)-10000), 1);
        run_ShortQuery(Short_filterR, intParameter, new Integer(-10000), Short.valueOf((short)-10000), 1);
        run_ShortQuery(Short_filterL, IntegerParameter, new Integer(10000), Short.valueOf((short)10000), 1);
        run_ShortQuery(Short_filterR, IntegerParameter, new Integer(10000), Short.valueOf((short)10000), 1);
        ...
        run_CharacterQuery(Character_filterL, byteParameter, new Byte((byte)Character.MIN_VALUE), Character.valueOf((char)Character.MIN_VALUE), 1);
        run_CharacterQuery(Character_filterR, ByteParameter, new Byte((byte)'a'), Character.valueOf('a'), 0);
        ...
        run_CharacterQuery(Character_filterL, intParameter, new Integer('z'), Character.valueOf('z'), 2);
        run_CharacterQuery(Character_filterR, intParameter, new Integer('z'), Character.valueOf('z'), 2);
        run_CharacterQuery(Character_filterL, IntegerParameter, new Integer('B'), Character.valueOf('B'), 1);
        run_CharacterQuery(Character_filterR, IntegerParameter, new Integer('B'), Character.valueOf('B'), 1);
        ...
        run_IntegerQuery(Integer_filterL, ByteParameter, new Byte((byte)100), new Integer(100), 2);
        run_IntegerQuery(Integer_filterR, ByteParameter, new Byte((byte)0), new Integer(0), 1);
        run_IntegerQuery(Integer_filterL, shortParameter, Short.valueOf((short)10000), new Integer(10000), 1);
        run_IntegerQuery(Integer_filterR, shortParameter, Short.valueOf((short)-1000), new Integer(-1000), 1);
        run_IntegerQuery(Integer_filterL, ShortParameter, Short.valueOf((short)-1000), new Integer(-1000), 1);
        run_IntegerQuery(Integer_filterL, charParameter, Character.valueOf((char)10000), new Integer(10000), 1);
        run_IntegerQuery(Integer_filterR, charParameter, Character.valueOf((char)10000), new Integer(10000), 1);
        run_IntegerQuery(Integer_filterL, CharacterParameter, Character.valueOf((char)100), new Integer(100), 2);
        run_IntegerQuery(Integer_filterR, CharacterParameter, Character.valueOf((char)10000), new Integer(10000), 1);
        run_IntegerQuery(Integer_filterL, longParameter, Long.valueOf(AllTypes.veryLargePositiveInt), new Integer(AllTypes.veryLargePositiveInt), 1);
        run_IntegerQuery(Integer_filterR, longParameter, Long.valueOf(AllTypes.veryLargeNegativeInt), new Integer(AllTypes.veryLargeNegativeInt), 1);
        run_IntegerQuery(Integer_filterL, LongParameter, Long.valueOf(10000), new Integer(10000), 1);
        run_IntegerQuery(Integer_filterR, LongParameter, Long.valueOf(43), new Integer(43), 0);
        run_IntegerQuery(Integer_filterL, floatParameter, Float.valueOf((float)AllTypes.veryLargePositiveInt), new Integer(AllTypes.veryLargePositiveInt), 1);
        run_IntegerQuery(Integer_filterR, floatParameter, Float.valueOf((float)AllTypes.veryLargeNegativeInt), new Integer(AllTypes.veryLargeNegativeInt), 1);
        run_IntegerQuery(Integer_filterL, FloatParameter, Float.valueOf((float)10000), new Integer(10000), 1);
        run_IntegerQuery(Integer_filterR, FloatParameter, Float.valueOf((float)43), new Integer(43), 0);
        run_IntegerQuery(Integer_filterL, doubleParameter, Double.valueOf(AllTypes.veryLargePositiveInt), new Integer(AllTypes.veryLargePositiveInt), 1);
        run_IntegerQuery(Integer_filterR, doubleParameter, Double.valueOf(AllTypes.veryLargeNegativeInt), new Integer(AllTypes.veryLargeNegativeInt), 1);
        run_IntegerQuery(Integer_filterL, DoubleParameter, Double.valueOf(10000), new Integer(10000), 1);
        run_IntegerQuery(Integer_filterR, DoubleParameter, Double.valueOf(43), new Integer(43), 0);
        ...
        run_LongQuery(Long_filterL, byteParameter, new Byte((byte)100), Long.valueOf(100), 2);
        run_LongQuery(Long_filterR, byteParameter, new Byte((byte)0), Long.valueOf(0), 1);
        run_LongQuery(Long_filterL, ByteParameter, new Byte((byte)100), Long.valueOf(100), 2);
        run_LongQuery(Long_filterR, ByteParameter, new Byte((byte)0), Long.valueOf(0), 1);
        ...
        run_LongQuery(Long_filterL, intParameter, new Integer(100), Long.valueOf(100), 2);
        run_LongQuery(Long_filterR, intParameter, new Integer(0), Long.valueOf(0), 1);
        run_LongQuery(Long_filterL, IntegerParameter, new Integer(23), Long.valueOf(23), 0);
        run_LongQuery(Long_filterR, IntegerParameter, new Integer(1000000), Long.valueOf(1000000), 1);
        run_LongQuery(Long_filterL, longParameter, Long.valueOf(100), Long.valueOf(100), 2);
...
//    run_LongQuery(Long_filterR, doubleParameter, Double.valueOf((double)Long.MAX_VALUE), Long.valueOf(Long.MAX_VALUE), 1);
        ...
        run_FloatQuery(Float_filterL, byteParameter, new Byte((byte)0), Float.valueOf(0.0f), 1);
        run_FloatQuery(Float_filterR, byteParameter, new Byte((byte)23), Float.valueOf(23.0f), 0);
        run_FloatQuery(Float_filterL, ByteParameter, new Byte((byte)34), Float.valueOf(34.0f), 0);
        run_FloatQuery(Float_filterR, ByteParameter, new Byte((byte)100), Float.valueOf(100.0f), 2);
        ...
        run_FloatQuery(Float_filterL, intParameter, new Integer(50000000), Float.valueOf(50000000.0f), 1);
        run_FloatQuery(Float_filterR, intParameter, new Integer(23), Float.valueOf(23.0f), 0);
        run_FloatQuery(Float_filterL, IntegerParameter, new Integer(34), Float.valueOf(34.0f), 0);
        run_FloatQuery(Float_filterR, IntegerParameter, new Integer(100), Float.valueOf(100.0f), 2);
        ...
        run_DoubleQuery(Double_filterL, byteParameter, new Byte((byte)100), Double.valueOf(100.0), 2);
        run_DoubleQuery(Double_filterR, byteParameter, new Byte((byte)0), Double.valueOf(0.0), 1);
        run_DoubleQuery(Double_filterL, ByteParameter, new Byte((byte)23), Double.valueOf(23.0), 0);
        run_DoubleQuery(Double_filterR, ByteParameter, new Byte((byte)100), Double.valueOf(100.0), 2);
        ...
        run_DoubleQuery(Double_filterL, intParameter, new Integer(100), Double.valueOf(100.0), 2);
        run_DoubleQuery(Double_filterR, intParameter, new Integer(0), Double.valueOf(0.0), 1);
        run_DoubleQuery(Double_filterL, IntegerParameter, new Integer(23), Double.valueOf(23.0), 0);
        run_DoubleQuery(Double_filterR, IntegerParameter, new Integer(100), Double.valueOf(100.0), 2);
