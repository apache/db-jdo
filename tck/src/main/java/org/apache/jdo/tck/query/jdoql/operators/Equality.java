...
//    run_longQuery(long_filterR, doubleParameter, Double.valueOf((double)Long.MAX_VALUE), Long.MAX_VALUE, 1);
        ...
        run_ByteQuery(Byte_filterL, intParameter, new Integer(50), Byte.valueOf((byte)50), 2);
        run_ByteQuery(Byte_filterR, intParameter, new Integer(50), Byte.valueOf((byte)50), 2);
        run_ByteQuery(Byte_filterL, IntegerParameter, new Integer(50), Byte.valueOf((byte)50), 2);
        run_ByteQuery(Byte_filterR, IntegerParameter, new Integer(75), Byte.valueOf((byte)75), 1);
        ...
        run_IntegerQuery(Integer_filterL, byteParameter, Byte.valueOf((byte)100), new Integer(100), 2);
        run_IntegerQuery(Integer_filterR, byteParameter, Byte.valueOf((byte)0), new Integer(0), 1);
        run_IntegerQuery(Integer_filterL, ByteParameter, Byte.valueOf((byte)100), new Integer(100), 2);
        run_IntegerQuery(Integer_filterR, ByteParameter, Byte.valueOf((byte)0), new Integer(0), 1);
