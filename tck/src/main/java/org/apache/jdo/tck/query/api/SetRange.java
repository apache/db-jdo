...
/**
 * <B>Title:</B> Set Range. <br>
 * <B>Keywords:</B> query <br>
 * <B>Assertion ID:</B> A14.6-20. <br>
 * <B>Assertion Description: </B> setRange(int fromIncl, int toExcl); Specify the number of
 * instances to skip over and the maximum number of result instances to return.
 */
public class SetRange extends QueryTest {

  /** */
  private static final String ASSERTION_FAILED = "Assertion A14.6-20 (SetRange) failed: ";
