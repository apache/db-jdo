...
/**
 * <B>Title:</B> Query with no Filter <br>
 * <B>Keywords:</B> query <br>
 * <B>Assertion ID:</B> A14.6.2-1. <br>
 * <B>Assertion Description: </B> If the <code>Query</code> filter is not specified, then it
 * defaults to <code>true</code>, which has the effect of filtering the input <code>Collection
 * </code> only for class type.
 */
public class QueryWithNoFilter extends QueryTest {

  /** */
  private static final String ASSERTION_FAILED = "Assertion A14.6.2-1 (QueryWithNoFilter) failed: ";
