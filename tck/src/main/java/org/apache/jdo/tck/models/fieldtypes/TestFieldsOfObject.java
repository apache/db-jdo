...
/**
 * <B>Title:</B> Support of field type Object. <br>
 * <B>Keywords:</B> model <br>
 * <B>Assertion ID:</B> A6.4.3-31. <br>
 * <B>Assertion Description: </B> JDO implementations must support fields of <code>Object</code>
 * class type as First Class Objects. The implementation is permitted, but is not required, to allow
 * any class to be assigned to the field. If an implementation restricts instances to be assigned to
 * the field, a <code>ClassCastException</code> must be thrown at the time of any incorrect
 * assignment.
 */
public class TestFieldsOfObject extends JDO_Test {
  ...
  private void checkValues(Object oid, Object startValue) {
    ...
    if (buffer.length() > 0) {
      fail(ASSERTION_FAILED, buffer.toString());
    }
  }
}
