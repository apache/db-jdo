...
/**
 * <B>Title:</B> New Query with Candidate Class <br>
 * <B>Keywords:</B> query <br>
 * <B>Assertion ID:</B> A14.5-5. <br>
 * <B>Assertion Description: </B> <code>PersistenceManager.newQuery(Class cls)</code> constructs a
 * query instance with the candidate class specified.
 */
