 ...
 * <B>Assertion ID:</B> A12.5.7-21 <br>
 * <B>Assertion Description: </B> If the transaction in which an instance is made transactional (by
 * calling PersistenceManager.makeTransactional or makeTransactionalAll) commits, then the transient
 * instance retains its values.
 */
