...
public class LessThan extends ComparisonTests {
    ...
    private void runQueries()
    {
        ...
        run_byteQuery(byte_filterL, IntegerParameter, Integer.valueOf(-10), (byte)-10, true, 7);
        run_byteQuery(byte_filterR, IntegerParameter, Integer.valueOf(-100), (byte)-100, false, 1);
        ...
        run_shortQuery(short_filterL, intParameter, Integer.valueOf(-10000), (short)-10000, true, 8);
        run_shortQuery(short_filterR, intParameter, Integer.valueOf(-10000), (short)-10000, false, 1);
        run_shortQuery(short_filterL, IntegerParameter, Integer.valueOf(10000), (short)10000, true, 1);
        ...
        run_charQuery(char_filterL, intParameter, Integer.valueOf('z'), 'z', true, 1);
        ...
        run_intQuery(int_filterL, intParameter, Integer.valueOf(AllTypes.VERY_LARGE_NEGATIVE_INT), AllTypes.VERY_LARGE_NEGATIVE_INT, true, 9);
        run_intQuery(int_filterR, intParameter, Integer.valueOf(AllTypes.VERY_LARGE_POSITIVE_INT), AllTypes.VERY_LARGE_POSITIVE_INT, false, 9);
        run_intQuery(int_filterR, intParameter, Integer.valueOf(23), 23, false, 4);
        run_intQuery(int_filterL, IntegerParameter, Integer.valueOf(1000000), 1000000, true, 1);
        run_intQuery(int_filterR, IntegerParameter, Integer.valueOf(1000), 1000, false, 6);
        ...
        run_intQuery(int_filterL, longParameter, Long.valueOf(AllTypes.VERY_LARGE_POSITIVE_INT), AllTypes.VERY_LARGE_POSITIVE_INT, true, 0);
        run_intQuery(int_filterR, longParameter, Long.valueOf(AllTypes.VERY_LARGE_NEGATIVE_INT), AllTypes.VERY_LARGE_NEGATIVE_INT, false, 0);
        ...
        run_intQuery(int_filterL, floatParameter, Float.valueOf((float)AllTypes.VERY_LARGE_POSITIVE_INT), AllTypes.VERY_LARGE_POSITIVE_INT, true, 0);
        run_intQuery(int_filterR, floatParameter, Float.valueOf((float)AllTypes.VERY_LARGE_NEGATIVE_INT), AllTypes.VERY_LARGE_NEGATIVE_INT, false, 0);
        ...
        run_intQuery(int_filterL, doubleParameter, Double.valueOf(AllTypes.VERY_LARGE_POSITIVE_INT), AllTypes.VERY_LARGE_POSITIVE_INT, true, 0);
        run_intQuery(int_filterR, doubleParameter, Double.valueOf(AllTypes.VERY_LARGE_NEGATIVE_INT), AllTypes.VERY_LARGE_NEGATIVE_INT, false, 0);
        ...
        run_longQuery(long_filterL, intParameter, Integer.valueOf(100), 100, true, 3);
        run_longQuery(long_filterR, intParameter, Integer.valueOf(0), 0, false, 4);
        run_longQuery(long_filterL, IntegerParameter, Integer.valueOf(23), 23, true, 5);
        run_longQuery(long_filterR, IntegerParameter, Integer.valueOf(1000000), 1000000, false, 8);
        ...
        run_doubleQuery(double_filterR, intParameter, Integer.valueOf(0), 0.0, false, 3);
        ...
        run_ByteQuery(Byte_filterR, IntegerParameter, Integer.valueOf(75), Byte.valueOf((byte)75), false, 7);
        ...
        run_ShortQuery(Short_filterL, intParameter, Integer.valueOf(-10000), Short.valueOf((short)-10000), true, 8);
        run_ShortQuery(Short_filterR, intParameter, Integer.valueOf(-10000), Short.valueOf((short)-10000), false, 1);
        run_ShortQuery(Short_filterL, IntegerParameter, Integer.valueOf(10000), Short.valueOf((short)10000), true, 1);
        run_ShortQuery(Short_filterR, IntegerParameter, Integer.valueOf(10000), Short.valueOf((short)10000), false, 8);
        ...
        run_CharacterQuery(Character_filterL, intParameter, Integer.valueOf('z'), Character.valueOf('z'), true, 1);
        run_CharacterQuery(Character_filterR, intParameter, Integer.valueOf('z'), Character.valueOf('z'), false, 7);
        run_CharacterQuery(Character_filterL, IntegerParameter, Integer.valueOf('B'), Character.valueOf('B'), true, 6);
        run_CharacterQuery(Character_filterR, IntegerParameter, Integer.valueOf('B'), Character.valueOf('B'), false, 3);
        ...
        run_IntegerQuery(Integer_filterL, intParameter, Integer.valueOf(AllTypes.VERY_LARGE_NEGATIVE_INT), Integer.valueOf(AllTypes.VERY_LARGE_NEGATIVE_INT), true, 9);
        run_IntegerQuery(Integer_filterR, intParameter, Integer.valueOf(AllTypes.VERY_LARGE_POSITIVE_INT), Integer.valueOf(AllTypes.VERY_LARGE_POSITIVE_INT), false, 9);
        run_IntegerQuery(Integer_filterR, intParameter, Integer.valueOf(23), Integer.valueOf(23), false, 4);
        run_IntegerQuery(Integer_filterL, IntegerParameter, Integer.valueOf(1000000), Integer.valueOf(1000000), true, 1);
        run_IntegerQuery(Integer_filterR, IntegerParameter, Integer.valueOf(1000), Integer.valueOf(1000), false, 6);
        run_IntegerQuery(Integer_filterL, byteParameter, Byte.valueOf((byte)100), Integer.valueOf(100), true, 4);
        run_IntegerQuery(Integer_filterR, byteParameter, Byte.valueOf((byte)0), Integer.valueOf(0), false, 3);
        run_IntegerQuery(Integer_filterL, ByteParameter, Byte.valueOf((byte)100), Integer.valueOf(100), true, 4);
        run_IntegerQuery(Integer_filterR, ByteParameter, Byte.valueOf((byte)0), Integer.valueOf(0), false, 3);
        run_IntegerQuery(Integer_filterL, shortParameter, Short.valueOf((short)10000), Integer.valueOf(10000), true, 2);
        run_IntegerQuery(Integer_filterR, shortParameter, Short.valueOf((short)-1000), Integer.valueOf(-1000), false, 2);
        run_IntegerQuery(Integer_filterL, ShortParameter, Short.valueOf((short)-1000), Integer.valueOf(-1000), true, 7);
        run_IntegerQuery(Integer_filterR, ShortParameter, Short.valueOf((short)-999), Integer.valueOf(-999), false, 3);
        run_IntegerQuery(Integer_filterL, charParameter, Character.valueOf((char)10000), Integer.valueOf(10000), true, 2);
        run_IntegerQuery(Integer_filterR, charParameter, Character.valueOf((char)10000), Integer.valueOf(10000), false, 7);
        run_IntegerQuery(Integer_filterL, CharacterParameter, Character.valueOf((char)100), Integer.valueOf(100), true, 4);
        run_IntegerQuery(Integer_filterR, CharacterParameter, Character.valueOf((char)10000), Integer.valueOf(10000), false, 7);
        run_IntegerQuery(Integer_filterL, longParameter, Long.valueOf(AllTypes.VERY_LARGE_POSITIVE_INT), Integer.valueOf(AllTypes.VERY_LARGE_POSITIVE_INT), true, 0);
        run_IntegerQuery(Integer_filterR, longParameter, Long.valueOf(AllTypes.VERY_LARGE_NEGATIVE_INT), Integer.valueOf(AllTypes.VERY_LARGE_NEGATIVE_INT), false, 0);
        run_IntegerQuery(Integer_filterL, LongParameter, Long.valueOf(10000), Integer.valueOf(10000), true, 2);
        run_IntegerQuery(Integer_filterR, LongParameter, Long.valueOf(43), Integer.valueOf(43), false, 4);
        run_IntegerQuery(Integer_filterL, floatParameter, Float.valueOf((float)AllTypes.VERY_LARGE_POSITIVE_INT), Integer.valueOf(AllTypes.VERY_LARGE_POSITIVE_INT), true, 0);
        run_IntegerQuery(Integer_filterR, floatParameter, Float.valueOf((float)AllTypes.VERY_LARGE_NEGATIVE_INT), Integer.valueOf(AllTypes.VERY_LARGE_NEGATIVE_INT), false, 0);
        run_IntegerQuery(Integer_filterL, FloatParameter, Float.valueOf((float)10000), Integer.valueOf(10000), true, 2);
        run_IntegerQuery(Integer_filterR, FloatParameter, Float.valueOf((float)43), Integer.valueOf(43), false, 4);
        run_IntegerQuery(Integer_filterL, doubleParameter, Double.valueOf(AllTypes.VERY_LARGE_POSITIVE_INT), Integer.valueOf(AllTypes.VERY_LARGE_POSITIVE_INT), true, 0);
        run_IntegerQuery(Integer_filterR, doubleParameter, Double.valueOf(AllTypes.VERY_LARGE_NEGATIVE_INT), Integer.valueOf(AllTypes.VERY_LARGE_NEGATIVE_INT), false, 0);
        run_IntegerQuery(Integer_filterL, DoubleParameter, Double.valueOf(10000), Integer.valueOf(10000), true, 2);
        run_IntegerQuery(Integer_filterR, DoubleParameter, Double.valueOf(1000001.0), Integer.valueOf(1000001), false, 9);
        run_IntegerQuery(Integer_filterL, BigIntegerParameter, new BigInteger("1000000"), Integer.valueOf(1000000), true, 1);
        run_IntegerQuery(Integer_filterR, BigIntegerParameter, new BigInteger("1000"), Integer.valueOf(1000), false, 6);
        run_IntegerQuery(Integer_filterL, BigDecimalParameter, new BigDecimal("10000.0"), Integer.valueOf(10000), true, 2);
        ...
        run_LongQuery(Long_filterL, intParameter, Integer.valueOf(100), Long.valueOf(100), true, 3);
        run_LongQuery(Long_filterR, intParameter, Integer.valueOf(0), Long.valueOf(0), false, 4);
        run_LongQuery(Long_filterL, IntegerParameter, Integer.valueOf(23), Long.valueOf(23), true, 5);
        run_LongQuery(Long_filterR, IntegerParameter, Integer.valueOf(1000000), Long.valueOf(1000000), false, 8);
        ...
        run_FloatQuery(Float_filterL, intParameter, Integer.valueOf(50000000), Float.valueOf(50000000.0f), true, 2);
        ...
        run_FloatQuery(Float_filterR, IntegerParameter, Integer.valueOf(100), Float.valueOf(100.0f), false, 3);
        ...
        run_DoubleQuery(Double_filterR, intParameter, Integer.valueOf(0), Double.valueOf(0.0), false, 3);
