...
public class LessThan extends ComparisonTests {
  ...
  public void testBytePrimitiveQueries() {
    ...
    try {
      ...
      run_byteQuery(pm, byte_filterL, byteParameter, Byte.valueOf((byte) 0), (byte) 0, true, 6);
      run_byteQuery(
          pm, byte_filterR, byteParameter, Byte.valueOf(Byte.MIN_VALUE), Byte.MIN_VALUE, false, 0);
      run_byteQuery(pm, byte_filterL, ByteParameter, Byte.valueOf((byte) 50), (byte) 50, true, 3);
      run_byteQuery(
          pm, byte_filterR, ByteParameter, Byte.valueOf(Byte.MAX_VALUE), Byte.MAX_VALUE, false, 9);
      run_byteQuery(
          pm, byte_filterL, shortParameter, Short.valueOf((short) 75), (byte) 75, true, 2);
      run_byteQuery(
          pm, byte_filterR, shortParameter, Short.valueOf((short) 75), (byte) 75, false, 7);
      run_byteQuery(
      ...
      run_byteQuery(
          pm, byte_filterL, CharacterParameter, Character.valueOf((char) 0), (byte) 0, true, 6);
      run_byteQuery(
          pm, byte_filterR, CharacterParameter, Character.valueOf((char) 0), (byte) 0, false, 3);
      ...
      run_byteQuery(pm, byte_filterL, IntegerParameter, Integer.valueOf(-10), (byte) -10, true, 7);
      run_byteQuery(
          pm, byte_filterR, IntegerParameter, Integer.valueOf(-100), (byte) -100, false, 1);
      run_byteQuery(pm, byte_filterL, longParameter, Long.valueOf(50), (byte) 50, true, 3);
      run_byteQuery(pm, byte_filterR, longParameter, Long.valueOf(60), (byte) 60, false, 7);
      run_byteQuery(pm, byte_filterL, LongParameter, Long.valueOf(-100), (byte) -100, true, 8);
      run_byteQuery(pm, byte_filterR, LongParameter, Long.valueOf(-100), (byte) -100, false, 1);
      run_byteQuery(
      ...
      run_byteQuery(
          pm, byte_filterR, FloatParameter, Float.valueOf((float) -100), (byte) -100, false, 1);
      run_byteQuery(pm, byte_filterL, doubleParameter, Double.valueOf(50), (byte) 50, true, 3);
      ...
      run_byteQuery(
          pm, byte_filterL, BigIntegerParameter, new BigInteger("50"), (byte) 50, true, 3);
      run_byteQuery(
          pm, byte_filterR, BigIntegerParameter, new BigInteger("-100"), (byte) -100, false, 1);
      run_byteQuery(
          pm, byte_filterL, BigDecimalParameter, new BigDecimal("50.000000"), (byte) 50, true, 3);
      run_byteQuery(
          pm, byte_filterR, BigDecimalParameter, new BigDecimal("10.00000"), (byte) 10, false, 4);
      alltypes.setbyte((byte) 50);
      run_byteQuery(pm, byte_filterObj, AllTypesParameter, alltypes, (byte) 50, true, 3);
      alltypes.setbyte((byte) 55);
      run_byteQuery(pm, byte_filterObj, AllTypesParameter, alltypes, (byte) 55, true, 3);
      run_byteQuery(pm, byte_filterVal, null, null, (byte) 100, false, 8);
    } finally {
      cleanupPM(pm);
    }
  }
  ...
  public void testShortPrimitiveQueries() {
    ...
    try {
      run_shortQuery(
          pm, short_filterL, shortParameter, Short.valueOf((short) 100), (short) 100, true, 3);
      run_shortQuery(
      ...
      run_shortQuery(
          pm, short_filterR, shortParameter, Short.valueOf((short) 1000), (short) 1000, false, 7);
      run_shortQuery(
      ...
      run_shortQuery(
          pm, short_filterL, ByteParameter, Byte.valueOf((byte) 100), (short) 100, true, 3);
      run_shortQuery(
      ...
      run_shortQuery(
          ...
          8);
      run_shortQuery(
          pm, short_filterL, intParameter, Integer.valueOf(-10000), (short) -10000, true, 8);
      run_shortQuery(
          pm, short_filterR, intParameter, Integer.valueOf(-10000), (short) -10000, false, 1);
      run_shortQuery(
          pm, short_filterL, IntegerParameter, Integer.valueOf(10000), (short) 10000, true, 1);
      run_shortQuery(
          pm, short_filterR, IntegerParameter, Integer.valueOf(30000), (short) 30000, false, 9);
      run_shortQuery(pm, short_filterL, longParameter, Long.valueOf(10000), (short) 10000, true, 1);
      run_shortQuery(
          pm,
          short_filterR,
          longParameter,
      ...
      run_shortQuery(
          pm, short_filterL, FloatParameter, Float.valueOf((float) -1000), (short) -1000, true, 7);
      run_shortQuery(
          pm, short_filterR, FloatParameter, Float.valueOf((float) 100), (short) 100, false, 5);
      run_shortQuery(
          pm, short_filterL, doubleParameter, Double.valueOf(-10000.0), (short) -10000, true, 8);
      run_shortQuery(
      ...
      run_shortQuery(
          pm, short_filterL, BigIntegerParameter, new BigInteger("10000"), (short) 10000, true, 1);
      run_shortQuery(
      ...
      run_shortQuery(pm, short_filterObj, AllTypesParameter, alltypes, (short) 100, true, 3);
      alltypes.setshort((short) 23);
      run_shortQuery(pm, short_filterObj, AllTypesParameter, alltypes, (short) 23, true, 5);
      run_shortQuery(pm, short_filterVal, null, null, (short) 1000, true, 2);
    } finally {
      cleanupPM(pm);
    }
  }
  ...
  public void testCharPrimitiveQueries() {
    ...
    try {
      ...
      run_charQuery(pm, char_filterR, charParameter, Character.valueOf('z'), 'z', false, 7);
      run_charQuery(pm, char_filterL, CharacterParameter, Character.valueOf(' '), ' ', true, 8);
      ...
      run_charQuery(pm, char_filterL, shortParameter, Short.valueOf((short) 'M'), 'M', true, 3);
      run_charQuery(pm, char_filterR, shortParameter, Short.valueOf((short) 'M'), 'M', false, 5);
      run_charQuery(pm, char_filterL, ShortParameter, Short.valueOf((short) 'A'), 'A', true, 7);
      run_charQuery(pm, char_filterR, ShortParameter, Short.valueOf((short) 'A'), 'A', false, 2);
      run_charQuery(pm, char_filterL, intParameter, Integer.valueOf('z'), 'z', true, 1);
      run_charQuery(pm, char_filterR, intParameter, Integer.valueOf('z'), 'z', false, 7);
      run_charQuery(pm, char_filterL, IntegerParameter, Integer.valueOf('B'), 'B', true, 6);
      run_charQuery(pm, char_filterR, IntegerParameter, Integer.valueOf('B'), 'B', false, 3);
      run_charQuery(pm, char_filterL, floatParameter, Float.valueOf('f'), 'f', true, 3);
      run_charQuery(pm, char_filterR, floatParameter, Float.valueOf(' '), ' ', false, 1);
      run_charQuery(pm, char_filterL, FloatParameter, Float.valueOf('z'), 'z', true, 1);
      run_charQuery(pm, char_filterR, FloatParameter, Float.valueOf('z'), 'z', false, 7);
      run_charQuery(pm, char_filterL, doubleParameter, Double.valueOf('B'), 'B', true, 6);
      run_charQuery(pm, char_filterR, doubleParameter, Double.valueOf('B'), 'B', false, 3);
      run_charQuery(pm, char_filterL, DoubleParameter, Double.valueOf('A'), 'A', true, 7);
      run_charQuery(pm, char_filterR, DoubleParameter, Double.valueOf('A'), 'A', false, 2);
      run_charQuery(
          pm, char_filterL, BigIntegerParameter, new BigInteger("65"), 'A', true, 7); // 'A' == 65
      run_charQuery(
          pm,
          char_filterR,
          BigIntegerParameter,
          ...
          7); // 'z' == 122
      run_charQuery(
          pm, char_filterL, BigDecimalParameter, new BigDecimal("65.00000"), 'A', true, 7);
      run_charQuery(
          pm,
          char_filterR,
          BigDecimalParameter,
      ...
      AllTypes alltypes = new AllTypes();
      alltypes.setchar('A');
      run_charQuery(pm, char_filterObj, AllTypesParameter, alltypes, 'A', true, 7);
      alltypes.setchar('b');
      run_charQuery(pm, char_filterObj, AllTypesParameter, alltypes, 'b', true, 3);
      run_charQuery(pm, char_filterVal, null, null, 'M', true, 3);
    } finally {
      cleanupPM(pm);
    }
  }
  ...
  public void testIntPrimitiveQueries() {
    ...
    try {
      ...
      run_intQuery(pm, int_filterL, IntegerParameter, Integer.valueOf(1000000), 1000000, true, 1);
      run_intQuery(pm, int_filterR, IntegerParameter, Integer.valueOf(1000), 1000, false, 6);
      run_intQuery(pm, int_filterL, byteParameter, Byte.valueOf((byte) 100), 100, true, 4);
      run_intQuery(pm, int_filterR, byteParameter, Byte.valueOf((byte) 0), 0, false, 3);
      run_intQuery(pm, int_filterL, ByteParameter, Byte.valueOf((byte) 100), 100, true, 4);
      run_intQuery(pm, int_filterR, ByteParameter, Byte.valueOf((byte) 0), 0, false, 3);
      run_intQuery(pm, int_filterL, shortParameter, Short.valueOf((short) 10000), 10000, true, 2);
      run_intQuery(pm, int_filterR, shortParameter, Short.valueOf((short) -1000), -1000, false, 2);
      run_intQuery(pm, int_filterL, ShortParameter, Short.valueOf((short) -1000), -1000, true, 7);
      run_intQuery(pm, int_filterR, ShortParameter, Short.valueOf((short) 10000), 10000, false, 7);
      run_intQuery(pm, int_filterL, charParameter, Character.valueOf((char) 100), 100, true, 4);
      run_intQuery(pm, int_filterR, charParameter, Character.valueOf((char) 0), 0, false, 3);
      run_intQuery(
          pm, int_filterL, CharacterParameter, Character.valueOf((char) 100), 100, true, 4);
      run_intQuery(
          pm, int_filterR, CharacterParameter, Character.valueOf((char) 10000), 10000, false, 7);
      run_intQuery(
          pm,
          int_filterL,
          longParameter,
      ...
      run_intQuery(
          ...
          false,
          0);
      run_intQuery(pm, int_filterL, LongParameter, Long.valueOf(10000), 10000, true, 2);
      ...
      run_intQuery(
          ...
          false,
          0);
      run_intQuery(pm, int_filterL, FloatParameter, Float.valueOf((float) 10000), 10000, true, 2);
      ...
      run_intQuery(
          ...
          false,
          0);
      run_intQuery(pm, int_filterL, DoubleParameter, Double.valueOf(10000), 10000, true, 2);
      run_intQuery(pm, int_filterR, DoubleParameter, Double.valueOf(43), 43, false, 4);
      run_intQuery(
          pm, int_filterL, BigIntegerParameter, new BigInteger("1000000"), 1000000, true, 1);
      run_intQuery(pm, int_filterR, BigIntegerParameter, new BigInteger("1000"), 1000, false, 6);
      run_intQuery(pm, int_filterL, BigDecimalParameter, new BigDecimal("10000.0"), 10000, true, 2);
      ...
      run_intQuery(pm, int_filterVal, null, null, 1000, false, 6);
    } finally {
      cleanupPM(pm);
    }
  }
  ...
  public void testLongPrimitiveQueries() {
    ...
    try {
      run_longQuery(
          pm, long_filterL, longParameter, Long.valueOf(Long.MIN_VALUE), Long.MIN_VALUE, true, 9);
      run_longQuery(
          pm, long_filterR, longParameter, Long.valueOf(Long.MAX_VALUE), Long.MAX_VALUE, false, 9);
      run_longQuery(pm, long_filterL, LongParameter, Long.valueOf(100), 100, true, 3);
      run_longQuery(pm, long_filterR, LongParameter, Long.valueOf(23), 23, false, 5);
      run_longQuery(pm, long_filterL, byteParameter, Byte.valueOf((byte) 100), 100, true, 3);
      run_longQuery(pm, long_filterR, byteParameter, Byte.valueOf((byte) 0), 0, false, 4);
      run_longQuery(pm, long_filterL, ByteParameter, Byte.valueOf((byte) 100), 100, true, 3);
      run_longQuery(pm, long_filterR, ByteParameter, Byte.valueOf((byte) 0), 0, false, 4);
      run_longQuery(pm, long_filterL, shortParameter, Short.valueOf((short) -1000), -1000, true, 6);
      run_longQuery(pm, long_filterR, shortParameter, Short.valueOf((short) 1000), 1000, false, 7);
      run_longQuery(pm, long_filterL, ShortParameter, Short.valueOf((short) 100), 100, true, 3);
      ...
      run_longQuery(pm, long_filterR, CharacterParameter, Character.valueOf((char) 0), 0, false, 4);
      run_longQuery(pm, long_filterL, intParameter, Integer.valueOf(100), 100, true, 3);
      run_longQuery(pm, long_filterR, intParameter, Integer.valueOf(0), 0, false, 4);
      run_longQuery(pm, long_filterL, IntegerParameter, Integer.valueOf(23), 23, true, 5);
      run_longQuery(
          pm, long_filterR, IntegerParameter, Integer.valueOf(1000000), 1000000, false, 8);
      run_longQuery(
          pm, long_filterL, floatParameter, Float.valueOf((float) -1000000.0), -1000000, true, 8);
      run_longQuery(
          pm,
          long_filterR,
          floatParameter,
          ...
          false,
          9);
      run_longQuery(pm, long_filterL, FloatParameter, Float.valueOf((float) 100.0), 100, true, 3);
      run_longQuery(pm, long_filterR, FloatParameter, Float.valueOf((float) 32.0), 32, false, 5);
      run_longQuery(
          pm, long_filterL, doubleParameter, Double.valueOf(-1000000.0), -1000000, true, 8);
      run_longQuery(
          pm,
          long_filterR,
          doubleParameter,
          ...
          false,
          9);
      run_longQuery(pm, long_filterL, DoubleParameter, Double.valueOf(100.0), 100, true, 3);
      ...
      run_longQuery(
          pm, long_filterR, BigIntegerParameter, new BigInteger("1000000"), 1000000, false, 8);
      run_longQuery(pm, long_filterL, BigDecimalParameter, new BigDecimal("100.0"), 100, true, 3);
      ...
      run_longQuery(pm, long_filterVal, null, null, 1000000, false, 8);
    } finally {
      cleanupPM(pm);
    }
  }
  ...
  public void testDoublePrimitiveQueries() {
    ...
    try {
      ...
      run_doubleQuery(
          ...
          false,
          9);
      run_doubleQuery(pm, double_filterL, DoubleParameter, Double.valueOf(0.0), 0.0, true, 6);
      ...
      run_doubleQuery(pm, double_filterR, byteParameter, Byte.valueOf((byte) 0), 0.0, false, 3);
      ...
      run_doubleQuery(
          pm, double_filterR, charParameter, Character.valueOf((char) 0), 0.0, false, 3);
      run_doubleQuery(
      ...
      run_doubleQuery(pm, double_filterR, shortParameter, Short.valueOf((short) 0), 0.0, false, 3);
      ...
      run_doubleQuery(pm, double_filterR, intParameter, Integer.valueOf(0), 0.0, false, 3);
      ...
      run_doubleQuery(pm, double_filterR, longParameter, Long.valueOf(0), 0.0, false, 3);
      ...
      run_doubleQuery(pm, double_filterL, floatParameter, Float.valueOf(0.0f), 0.0f, true, 6);
      ...
      run_doubleQuery(pm, double_filterObj, AllTypesParameter, alltypes, -25.5, true, 7);
  ...
  public void testByteQueries() {
    ...
    try {
      ...
      run_ByteQuery(
          ...
          7);
      run_ByteQuery(
          pm, Byte_filterL, longParameter, Long.valueOf(50), Byte.valueOf((byte) 50), true, 3);
      run_ByteQuery(
          pm, Byte_filterR, longParameter, Long.valueOf(50), Byte.valueOf((byte) 50), false, 5);
      run_ByteQuery(
          pm, Byte_filterL, LongParameter, Long.valueOf(-100), Byte.valueOf((byte) -100), true, 8);
      run_ByteQuery(
          pm, Byte_filterR, LongParameter, Long.valueOf(-100), Byte.valueOf((byte) -100), false, 1);
      run_ByteQuery(
          pm,
          Byte_filterL,
          floatParameter,
      ...
      run_ByteQuery(
          ...
          1);
      run_ByteQuery(
          pm, Byte_filterL, doubleParameter, Double.valueOf(50), Byte.valueOf((byte) 50), true, 3);
      run_ByteQuery(
      ...
      run_ByteQuery(pm, Byte_filterVal, null, null, Byte.valueOf((byte) 100), true, 1);
    } finally {
      cleanupPM(pm);
    }
  }
  ...
  public void testShortQueries() {
    ...
    try {
      ...
      alltypes.setShort(sval);
      run_ShortQuery(pm, Short_filterObj, AllTypesParameter, alltypes, sval, false, 5);
      run_ShortQuery(pm, Short_filterVal, null, null, Short.valueOf((short) -1000), true, 7);
    } finally {
      cleanupPM(pm);
    }
  }
  ...
  public void testCharacterQueries() {
    ...
    try {
      ...
      run_CharacterQuery(
          ...
          3);
      run_CharacterQuery(
          pm, Character_filterL, longParameter, Long.valueOf('z'), Character.valueOf('z'), true, 1);
      run_CharacterQuery(
          pm,
          Character_filterR,
          longParameter,
          ...
          7);
      run_CharacterQuery(
          pm, Character_filterL, LongParameter, Long.valueOf('B'), Character.valueOf('B'), true, 6);
      run_CharacterQuery(
          pm,
          Character_filterR,
          LongParameter,
      ...
      run_CharacterQuery(
          pm, Character_filterObj, AllTypesParameter, alltypes, Character.valueOf('A'), true, 7);
      alltypes.setCharacter(Character.valueOf('b'));
      run_CharacterQuery(
          pm, Character_filterObj, AllTypesParameter, alltypes, Character.valueOf('b'), true, 3);
      run_CharacterQuery(pm, Character_filterVal, null, null, Character.valueOf('z'), false, 7);
    } finally {
      cleanupPM(pm);
    }
  }
  ...
  public void testIntegerQueries() {
    ...
    try {
      ...
      run_IntegerQuery(
          ...
          4);
      run_IntegerQuery(
          pm, Integer_filterR, byteParameter, Byte.valueOf((byte) 0), Integer.valueOf(0), false, 3);
      run_IntegerQuery(
          pm,
          Integer_filterL,
          ByteParameter,
      ...
      run_IntegerQuery(
          ...
          0);
      run_IntegerQuery(
          pm, Integer_filterL, LongParameter, Long.valueOf(10000), Integer.valueOf(10000), true, 2);
      run_IntegerQuery(
  ...
  public void testLongQueries() {
    ...
    try {
      ...
      run_LongQuery(
          ...
          false,
          9);
      run_LongQuery(pm, Long_filterL, LongParameter, Long.valueOf(100), Long.valueOf(100), true, 3);
      run_LongQuery(pm, Long_filterR, LongParameter, Long.valueOf(23), Long.valueOf(23), false, 5);
      run_LongQuery(
          pm, Long_filterL, byteParameter, Byte.valueOf((byte) 100), Long.valueOf(100), true, 3);
      run_LongQuery(
          pm, Long_filterR, byteParameter, Byte.valueOf((byte) 0), Long.valueOf(0), false, 4);
      run_LongQuery(
          pm, Long_filterL, ByteParameter, Byte.valueOf((byte) 100), Long.valueOf(100), true, 3);
      run_LongQuery(
          pm, Long_filterR, ByteParameter, Byte.valueOf((byte) 0), Long.valueOf(0), false, 4);
      ...
      run_LongQuery(
          ...
          8);
      run_LongQuery(
          pm, Long_filterL, intParameter, Integer.valueOf(100), Long.valueOf(100), true, 3);
      run_LongQuery(pm, Long_filterR, intParameter, Integer.valueOf(0), Long.valueOf(0), false, 4);
      run_LongQuery(
      ...
      run_LongQuery(
          ...
          9);
      run_LongQuery(
          pm, Long_filterL, FloatParameter, Float.valueOf(100.0f), Long.valueOf(100), true, 3);
      run_LongQuery(
      ...
      run_LongQuery(
          ...
          9);
      run_LongQuery(
          pm, Long_filterL, DoubleParameter, Double.valueOf(100.0), Long.valueOf(100), true, 3);
      run_LongQuery(
      ...
      run_LongQuery(pm, Long_filterObj, AllTypesParameter, alltypes, Long.valueOf(100), true, 3);
      run_LongQuery(pm, Long_filterVal, null, null, Long.valueOf(-1000), true, 6);
    } finally {
      cleanupPM(pm);
    }
  }
  ...
  public void testFloatQueries() {
    ...
    try {
      ...
      run_FloatQuery(
          ...
          3);
      run_FloatQuery(
          pm, Float_filterL, byteParameter, Byte.valueOf((byte) 0), Float.valueOf(0.0f), true, 7);
      run_FloatQuery(
          pm,
          Float_filterR,
          byteParameter,
      ...
      run_FloatQuery(
          pm, Float_filterR, LongParameter, Long.valueOf(100), Float.valueOf(100.0f), false, 3);
      run_FloatQuery(
          pm,
          Float_filterL,
          doubleParameter,
      ...
      run_FloatQuery(
          ...
          3);
      run_FloatQuery(
          pm, Float_filterL, DoubleParameter, Double.valueOf(0.0f), Float.valueOf(0.0f), true, 7);
      run_FloatQuery(
          pm,
          Float_filterR,
          DoubleParameter,
  ...
  public void testDoubleQueries() {
    ...
    try {
      ...
      run_DoubleQuery(
          ...
          9);
      run_DoubleQuery(
          pm, Double_filterL, DoubleParameter, Double.valueOf(0.0), Double.valueOf(0.0), true, 6);
      run_DoubleQuery(
          pm,
          Double_filterR,
          DoubleParameter,
      ...
      run_DoubleQuery(
          ...
          4);
      run_DoubleQuery(
          pm, Double_filterR, byteParameter, Byte.valueOf((byte) 0), Double.valueOf(0.0), false, 3);
      run_DoubleQuery(
          pm,
          Double_filterL,
          ByteParameter,
      ...
      run_DoubleQuery(
          pm, Double_filterR, intParameter, Integer.valueOf(0), Double.valueOf(0.0), false, 3);
      run_DoubleQuery(
      ...
      run_DoubleQuery(
          pm, Double_filterR, longParameter, Long.valueOf(0), Double.valueOf(0.0), false, 3);
      run_DoubleQuery(
      ...
      run_DoubleQuery(
          pm, Double_filterL, floatParameter, Float.valueOf(0.0f), Double.valueOf(0.0f), true, 6);
      run_DoubleQuery(
          pm,
          Double_filterR,
          floatParameter,
  ...
  public void testStringQueries() {
    PersistenceManager pm = getPMF().getPersistenceManager();
    try {
      run_StringQuery(pm, String_filterL, StringParameter, "JDO", "JDO", true, 8);
      run_StringQuery(pm, String_filterR, StringParameter, "JDBC", "JDBC", false, 1);
      AllTypes alltypes = new AllTypes();
      alltypes.setString("abcde");
      run_StringQuery(pm, String_filterObj, AllTypesParameter, alltypes, "abcde", true, 2);
      run_StringQuery(pm, String_filterVal1, null, null, "Java", false, 4);
      run_StringQuery(pm, String_filterVal2, null, null, "", false, 0);
    } finally {
      cleanupPM(pm);
    }
  }
  ...
  public void testBigDecimalQueries() {
    ...
    try {
      ...
      run_BigDecimalQuery(pm, BigDecimal_filterR, BigDecimalParameter, bd, bd, false, 0);
      AllTypes alltypes = new AllTypes();
      alltypes.setBigDecimal(bd);
      run_BigDecimalQuery(pm, BigDecimal_filterObj, AllTypesParameter, alltypes, bd, true, 9);
    } finally {
      cleanupPM(pm);
    }
  }
  ...
  public void testBigIntegerQueries() {
    ...
    try {
      ...
      run_BigIntegerQuery(pm, BigInteger_filterL, BigIntegerParameter, bi, bi, true, 0);
      ...
      run_BigIntegerQuery(pm, BigInteger_filterObj, AllTypesParameter, alltypes, bi, false, 7);
    } finally {
      cleanupPM(pm);
    }
  }
  ...
  public void testDateQueries() {
    ...
    try {
      ...
      Date d = gc.getTime();
      run_DateQuery(pm, Date_filterL, DateParameter, d, d, true, 2);
      ...
      AllTypes alltypes = new AllTypes();
      alltypes.setDate(d);
      run_DateQuery(pm, Date_filterObj, AllTypesParameter, alltypes, d, false, 6);
    } finally {
      cleanupPM(pm);
    }
  }
