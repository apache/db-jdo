 ...
 * <B>Assertion IDs:</B> A11.4-9A. <br>
 * <B>Assertion Description: </B> If a set method is called after close, then JDOUserException is
 * thrown.
 */
