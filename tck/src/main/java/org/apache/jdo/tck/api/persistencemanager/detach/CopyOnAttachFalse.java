 ...
 * <B>Assertion Description: </B> A12.6.8-29 [If the CopyOnAttach property is false, then the
 * instance itself is transitioned to persistent-clean for datastore transactions or
 * persistent-nontransactional for optimistic transactions. If there already is an instance in the
 * cache with the same identity, JDOUserException is thrown.]
 */
public class CopyOnAttachFalse extends DetachTest {
  ...
  public void testNegativeAttachClean() {
    ...
    try {
      Cart attachedCart = pm.makePersistent(detachedCart);
      fail(
          "Expected JDOUserException. Object with same identity as "
