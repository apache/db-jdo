 ...
 * <B>Assertion ID:</B> A8.3-3. <br>
 * <B>Assertion Description: </B> The jdohelper.getObjectId method returns null if Object is not
 * persistence capable
 */
...
public class GetObjectIdNotPersistenceCapable extends JDO_Test {
  ...
  public void testGetObjectIdNotPersistenceCapable() {
    ...
    if (oid != null)
      fail(
          ASSERTION_FAILED,
          "JDOHelper.getObjectId called for instance of non-pc class returned non-null ObjectId "
              + oid);
    pm.close();
    pm = null;
  }
