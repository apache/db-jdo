...
/**
 * <B>Title:</B> Set Result Class. <br>
 * <B>Keywords:</B> query <br>
 * <B>Assertion ID:</B> A14.6-19. <br>
 * <B>Assertion Description: </B> void setResultClass (Class resultClass); Specify the class to be
 * used to return result instances.
 */
public class SetResultClass extends QueryTest {

  /** */
  private static final String ASSERTION_FAILED = "Assertion A14.6-19 (SetResultClass) failed: ";
