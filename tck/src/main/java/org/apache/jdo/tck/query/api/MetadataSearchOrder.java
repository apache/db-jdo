...
public class MetadataSearchOrder extends QueryTest {
  ...
  private Object[] expectedResult = {
    ...
    getTransientMylibInstancesAsList(new String[] {"pcClass1", "pcClass2"}),
    getTransientCompanyModelInstancesAsList(new String[] {"emp3", "emp4", "emp5"}),
    getTransientCompanyModelInstancesAsList(new String[] {"emp4", "emp5"})
  };
  ...
  private void executeNamedQuery(Class candidateClass, String namedQuery, Object expectedResult) {
