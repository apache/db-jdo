...
/**
 * <B>Title:</B> Iterators <br>
 * <B>Keywords:</B> extent <br>
 * <B>Assertion ID:</B> A15.3-1. <br>
 * <B>Assertion Description: </B> <code>Extent.iterator()</code> returns an <code>Iterator</code>
...
public class Iterators extends ExtentTest {
  ...
  public void test() {
    ...
    if (count != 2) {
      fail(ASSERTION_FAILED, "Emplyoee extent should have 2 instances, got " + count);
    }
  }
}
