 ...
 * <B>Assertion ID:</B> A14.7-1. <br>
 * <B>Assertion Description: </B> In this case, the factory method that takes the language string
 * and Object is used: newQuery (String language, Object query). The language parameter is
 * javax.jdo.query.SQL and the query parameter is the SQL query string.
 */
public class NewQuery extends QueryTest {
  ...
  private Object[] expectedResult = {
    Arrays.asList(new Object[] {new Object[] {"emp1First", "emp1Last"}})
  };

  /** Parameters of valid SQL queries. */
  private static Object[][] parameters = {{Integer.valueOf(1)}};
