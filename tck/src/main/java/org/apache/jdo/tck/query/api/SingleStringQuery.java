 ...
 * <B>Assertion ID:</B> A14.6-23. <br>
 * <B>Assertion Description: </B> The single string query is first parsed to yield the result,
 * result class, filter, variable list, parameter list, import list, grouping, ordering, and range.
 * Then, the values specified in APIs setResult, setResultClass, setFilter, declareVariables,
 * declareParamters, declareImports, setGrouping, setOrdering, and setRange override the
...
public class SingleStringQuery extends QueryTest {
  ...
  private Object[][] parameters = {{new BigDecimal("2000")}};
