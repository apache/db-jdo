...
public class PersistenceManagerNullsTest extends JDO_Test {
  ...
  public void executeNullObjectParameter(MethodUnderTest mut, String method) {
    ...
    try {
      ...
      try {
        ...
        fail(
            ASSERTION3_FAILED,
            method + " on a null object should do nothing." + " Instead we get: " + e.toString());
      }
      tx.commit();
   ...
   * @param method method name
   */
  public void executeCollectionNullElement(Collection coll, MethodUnderTest mut, String method) {
    ...
    try {
      ...
      try {
        ...
        fail(
            ASSERTION5_FAILED,
            method
                + " on a null Collection element should"
                + " do nothing. Instead we get: "
                + e.toString());
        e.printStackTrace();
      }
    ...
    try {
      ...
      try {
        ...
        fail(
            ASSERTION5_FAILED,
            method
                + " on a null array element should "
                + "do nothing. Instead we get: "
                + e.toString());
        e.printStackTrace();
      }
   ...
   * @param method method name
   */
  public void executeCollectionNullElementReturn(
      Collection coll, MethodUnderTest mut, String method) {
