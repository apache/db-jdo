...
public class SignatureVerifier {
   ...
   */
  public int test(List descrFileNames) throws IOException, ParseException {
    // check argument
  ...
  protected String checkValue(String value, String type, Object actual)
    ...
    if (type.equals("byte")) {
      ...
      if (isArray) {
        ...
        System.out.println(
            "WARNING : checkValue value=" + value + " type=" + type + " comes up with null class");
        ok = false;
        ...
        try {
          ...
          String expectedFieldName = value.substring(lastDot + 1, value.length());
  ...
  protected class Parser {
    ...
    protected int parseModifiers() throws IOException, ParseException {
      ...
      while (true) {
        ...
        else if (t.equals("annotation")) m |= (ANNOTATION + Modifier.ABSTRACT + Modifier.INTERFACE);
     ...
     */
    @SuppressWarnings("empty-statement")
    public void parse(List descrFileNames) throws IOException, ParseException {
  ...
  public static final List descrFileNames = new ArrayList();
