...
public class CorrelatedSubqueriesWithParameters extends SubqueriesTest {
  ...
  void runTestSubqueries01(PersistenceManager pm) {
    List expectedResult =
        getTransientCompanyModelInstancesAsList(new String[] {"emp2", "emp6", "emp9"});
  ...
  void runTestSubqueries02(PersistenceManager pm) {
    List expectedResult = getTransientCompanyModelInstancesAsList(new String[] {"emp2", "emp10"});
  ...
  void runTestSubqueries03(PersistenceManager pm) {
    List expectedResult =
        getTransientCompanyModelInstancesAsList(new String[] {"emp2", "emp6", "emp9", "emp10"});
