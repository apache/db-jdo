...
public class NotEquals extends ComparisonTests {
    ...
    private void runQueries()
    {
        ...
        run_shortQuery(short_filterL, ShortParameter, Short.valueOf(Short.MIN_VALUE), Short.MIN_VALUE, 9);
        ...
        run_shortQuery(short_filterL, CharacterParameter, Character.valueOf((char)100), (short)100, 8);
        run_shortQuery(short_filterR, CharacterParameter, Character.valueOf((char)100), (short)100, 8);
        ...
        run_charQuery(char_filterL, charParameter, Character.valueOf(Character.MIN_VALUE), Character.MIN_VALUE, 9);
        run_charQuery(char_filterR, charParameter, Character.valueOf(Character.MAX_VALUE), Character.MAX_VALUE, 9);
...
//    run_longQuery(long_filterR, floatParameter, Float.valueOf((float)Long.MAX_VALUE), Long.MAX_VALUE, 9);
...
//    run_longQuery(long_filterR, doubleParameter, Double.valueOf((double)Long.MAX_VALUE), Long.MAX_VALUE, 9);
        ...
        run_ByteQuery(Byte_filterR, byteParameter, Byte.valueOf(Byte.MIN_VALUE), Byte.valueOf(Byte.MIN_VALUE), 9);
        run_ByteQuery(Byte_filterL, ByteParameter, Byte.valueOf((byte)20), Byte.valueOf((byte)20), 10);
        run_ByteQuery(Byte_filterR, ByteParameter, Byte.valueOf(Byte.MAX_VALUE), Byte.valueOf(Byte.MAX_VALUE), 9);    
        run_ByteQuery(Byte_filterL, shortParameter, Short.valueOf((short)50), Byte.valueOf((byte)50), 8);
        run_ByteQuery(Byte_filterR, shortParameter, Short.valueOf((short)50), Byte.valueOf((byte)50), 8);
        run_ByteQuery(Byte_filterL, ShortParameter, Short.valueOf((short)-100), Byte.valueOf((byte)-100), 9);
        run_ByteQuery(Byte_filterR, ShortParameter, Short.valueOf((short)-100), Byte.valueOf((byte)-100), 9);
        run_ByteQuery(Byte_filterL, charParameter, Character.valueOf((char)50), Byte.valueOf((byte)50), 8);
        run_ByteQuery(Byte_filterR, charParameter, Character.valueOf((char)50), Byte.valueOf((byte)50), 8);
        run_ByteQuery(Byte_filterL, CharacterParameter, Character.valueOf((char)50), Byte.valueOf((byte)50), 8);
        run_ByteQuery(Byte_filterR, CharacterParameter, Character.valueOf((char)75), Byte.valueOf((byte)75), 9);
        run_ByteQuery(Byte_filterL, intParameter, new Integer(50), Byte.valueOf((byte)50), 8);
        run_ByteQuery(Byte_filterR, intParameter, new Integer(50), Byte.valueOf((byte)50), 8);
        run_ByteQuery(Byte_filterL, IntegerParameter, new Integer(50), Byte.valueOf((byte)50), 8);
        run_ByteQuery(Byte_filterR, IntegerParameter, new Integer(75), Byte.valueOf((byte)75), 9);
        ...
        run_ByteQuery(Byte_filterL, floatParameter, Float.valueOf((float)50), Byte.valueOf((byte)50), 8);
        run_ByteQuery(Byte_filterR, floatParameter, Float.valueOf((float)50), Byte.valueOf((byte)50), 8);
        run_ByteQuery(Byte_filterL, FloatParameter, Float.valueOf((float)-100), Byte.valueOf((byte)-100), 9);
        run_ByteQuery(Byte_filterR, FloatParameter, Float.valueOf((float)-100), Byte.valueOf((byte)-100), 9);
        ...
        run_ByteQuery(Byte_filterL, DoubleParameter, Double.valueOf(-100), Byte.valueOf((byte)-100), 9);
        run_ByteQuery(Byte_filterR, DoubleParameter, Double.valueOf(-100), Byte.valueOf((byte)-100), 9);
        run_ByteQuery(Byte_filterL, BigIntegerParameter, new BigInteger("50"), Byte.valueOf((byte)50), 8);
        run_ByteQuery(Byte_filterR, BigIntegerParameter, new BigInteger("-100"), Byte.valueOf((byte)-100), 9);
        run_ByteQuery(Byte_filterL, BigDecimalParameter, new BigDecimal("100.0"), Byte.valueOf((byte)100), 9);
        run_ByteQuery(Byte_filterR, BigDecimalParameter, new BigDecimal("10.0"), Byte.valueOf((byte)10), 9);    
        ...
        run_ShortQuery(Short_filterL, shortParameter, Short.valueOf((short)100), Short.valueOf((short)100), 8);
        run_ShortQuery(Short_filterR, shortParameter, Short.valueOf((short)100), Short.valueOf((short)100), 8);
        run_ShortQuery(Short_filterL, ShortParameter, Short.valueOf(Short.MIN_VALUE), Short.valueOf(Short.MIN_VALUE), 9);
        run_ShortQuery(Short_filterR, ShortParameter, Short.valueOf((short)253), Short.valueOf((short)253), 10);
        run_ShortQuery(Short_filterR, shortParameter, Short.valueOf((short)1000), Short.valueOf((short)1000), 9);
        run_ShortQuery(Short_filterL, byteParameter, Byte.valueOf((byte)75), Short.valueOf((short)75), 10);
        run_ShortQuery(Short_filterR, byteParameter, Byte.valueOf((byte)75), Short.valueOf((short)75), 10);
        run_ShortQuery(Short_filterL, ByteParameter, Byte.valueOf((byte)100), Short.valueOf((short)100), 8);
        run_ShortQuery(Short_filterR, ByteParameter, Byte.valueOf((byte)100), Short.valueOf((short)100), 8);
        run_ShortQuery(Short_filterL, charParameter, Character.valueOf((char)75), Short.valueOf((short)75), 10);
        run_ShortQuery(Short_filterR, charParameter, Character.valueOf((char)75), Short.valueOf((short)75), 10);
        run_ShortQuery(Short_filterL, CharacterParameter, Character.valueOf((char)100), Short.valueOf((short)100), 8);
        run_ShortQuery(Short_filterR, CharacterParameter, Character.valueOf((char)100), Short.valueOf((short)100), 8);
        run_ShortQuery(Short_filterL, intParameter, new Integer(-10000), Short.valueOf((short)-10000), 9);
        run_ShortQuery(Short_filterR, intParameter, new Integer(-10000), Short.valueOf((short)-10000), 9);
        run_ShortQuery(Short_filterL, IntegerParameter, new Integer(10000), Short.valueOf((short)10000), 9);
        run_ShortQuery(Short_filterR, IntegerParameter, new Integer(10000), Short.valueOf((short)10000), 9);
        run_ShortQuery(Short_filterL, longParameter, Long.valueOf(10000), Short.valueOf((short) 10000), 9);
        run_ShortQuery(Short_filterR, longParameter, Long.valueOf(10000), Short.valueOf((short) 10000), 9);
        ...
        run_ShortQuery(Short_filterL, floatParameter, Float.valueOf((float)23000), Short.valueOf((short)23000), 10);
        run_ShortQuery(Short_filterR, floatParameter, Float.valueOf((float)23000), Short.valueOf((short)23000), 10);
        run_ShortQuery(Short_filterL, FloatParameter, Float.valueOf((float)100), Short.valueOf((short)100), 8);
        run_ShortQuery(Short_filterR, FloatParameter, Float.valueOf((float)100), Short.valueOf((short)100), 8);
        run_ShortQuery(Short_filterL, doubleParameter, Double.valueOf(-10000), Short.valueOf((short)-10000), 9);
        run_ShortQuery(Short_filterR, doubleParameter, Double.valueOf(-10000), Short.valueOf((short)-10000), 9);
        run_ShortQuery(Short_filterL, DoubleParameter, Double.valueOf(23), Short.valueOf((short)23), 10);
        run_ShortQuery(Short_filterR, DoubleParameter, Double.valueOf(23), Short.valueOf((short)23), 10);
        run_ShortQuery(Short_filterL, BigIntegerParameter, new BigInteger("999"), Short.valueOf((short)999), 10);
        run_ShortQuery(Short_filterR, BigIntegerParameter, new BigInteger("-1000"), Short.valueOf((short)-1000), 9);
        run_ShortQuery(Short_filterL, BigDecimalParameter, new BigDecimal("100.0"), Short.valueOf((short)100), 8);
        run_ShortQuery(Short_filterR, BigDecimalParameter, new BigDecimal("10000.0"), Short.valueOf((short)10000), 9);    
        ...
        run_CharacterQuery(Character_filterL, charParameter, Character.valueOf(Character.MIN_VALUE), Character.valueOf(Character.MIN_VALUE), 9);
        run_CharacterQuery(Character_filterR, charParameter, Character.valueOf(Character.MAX_VALUE), Character.valueOf(Character.MAX_VALUE), 9);
        run_CharacterQuery(Character_filterL, charParameter, Character.valueOf('C'), Character.valueOf('C'), 10);
        ...
        run_CharacterQuery(Character_filterL, ShortParameter, Short.valueOf((short)'A'), Character.valueOf('A'), 9);
        run_CharacterQuery(Character_filterR, ShortParameter, Short.valueOf((short)'A'), Character.valueOf('A'), 9);
        run_CharacterQuery(Character_filterL, intParameter, new Integer('z'), Character.valueOf('z'), 8);
        run_CharacterQuery(Character_filterR, intParameter, new Integer('z'), Character.valueOf('z'), 8);
        run_CharacterQuery(Character_filterL, IntegerParameter, new Integer('B'), Character.valueOf('B'), 9);
        run_CharacterQuery(Character_filterR, IntegerParameter, new Integer('B'), Character.valueOf('B'), 9);
        run_CharacterQuery(Character_filterL, longParameter, Long.valueOf('z'), Character.valueOf('z'), 8);
        run_CharacterQuery(Character_filterR, longParameter, Long.valueOf('z'), Character.valueOf('z'), 8);
        run_CharacterQuery(Character_filterL, LongParameter, Long.valueOf('B'), Character.valueOf('B'), 9);
        ...
        run_CharacterQuery(Character_filterR, DoubleParameter, Double.valueOf('A'), Character.valueOf('A'), 9);
        run_CharacterQuery(Character_filterL, BigIntegerParameter, new BigInteger("65"), Character.valueOf('A'), 9);   // 'A' == 65
        run_CharacterQuery(Character_filterR, BigIntegerParameter, new BigInteger("122"), Character.valueOf('z'), 8);  // 'z' == 122
        run_CharacterQuery(Character_filterL, BigDecimalParameter, new BigDecimal("65.000000"), Character.valueOf('A'), 9);
        run_CharacterQuery(Character_filterR, BigDecimalParameter, new BigDecimal("77.0"), Character.valueOf('M'), 8); // 'M' == 77
        ...
        run_IntegerQuery(Integer_filterL, byteParameter, Byte.valueOf((byte)100), new Integer(100), 8);
        run_IntegerQuery(Integer_filterR, byteParameter, Byte.valueOf((byte)0), new Integer(0), 9);
        run_IntegerQuery(Integer_filterL, ByteParameter, Byte.valueOf((byte)100), new Integer(100), 8);
        run_IntegerQuery(Integer_filterR, ByteParameter, Byte.valueOf((byte)0), new Integer(0), 9);
        run_IntegerQuery(Integer_filterL, shortParameter, Short.valueOf((short)10000), new Integer(10000), 9);
        run_IntegerQuery(Integer_filterR, shortParameter, Short.valueOf((short)-1000), new Integer(-1000), 9);
        run_IntegerQuery(Integer_filterL, ShortParameter, Short.valueOf((short)-1000), new Integer(-1000), 9);
        run_IntegerQuery(Integer_filterL, charParameter, Character.valueOf((char)10000), new Integer(10000), 9);
        run_IntegerQuery(Integer_filterR, charParameter, Character.valueOf((char)100), new Integer(100), 8);
        run_IntegerQuery(Integer_filterL, CharacterParameter, Character.valueOf((char)10000), new Integer(10000), 9);
        run_IntegerQuery(Integer_filterR, CharacterParameter, Character.valueOf((char)10000), new Integer(10000), 9);
        run_IntegerQuery(Integer_filterL, longParameter, Long.valueOf(AllTypes.veryLargePositiveInt), new Integer(AllTypes.veryLargePositiveInt), 9);
        run_IntegerQuery(Integer_filterR, longParameter, Long.valueOf(AllTypes.veryLargeNegativeInt), new Integer(AllTypes.veryLargeNegativeInt), 9);
        run_IntegerQuery(Integer_filterL, LongParameter, Long.valueOf(10000), new Integer(10000), 9);
        run_IntegerQuery(Integer_filterR, LongParameter, Long.valueOf(43), new Integer(43), 10);
        run_IntegerQuery(Integer_filterL, floatParameter, Float.valueOf((float)AllTypes.veryLargePositiveInt), new Integer(AllTypes.veryLargePositiveInt), 9);
        run_IntegerQuery(Integer_filterR, floatParameter, Float.valueOf((float)AllTypes.veryLargeNegativeInt), new Integer(AllTypes.veryLargeNegativeInt), 9);
        run_IntegerQuery(Integer_filterL, FloatParameter, Float.valueOf((float)10000), new Integer(10000), 9);
        run_IntegerQuery(Integer_filterR, FloatParameter, Float.valueOf((float)43), new Integer(43), 10);
        run_IntegerQuery(Integer_filterL, doubleParameter, Double.valueOf(AllTypes.veryLargePositiveInt), new Integer(AllTypes.veryLargePositiveInt), 9);
        run_IntegerQuery(Integer_filterR, doubleParameter, Double.valueOf(AllTypes.veryLargeNegativeInt), new Integer(AllTypes.veryLargeNegativeInt), 9);
        run_IntegerQuery(Integer_filterL, DoubleParameter, Double.valueOf(10000), new Integer(10000), 9);
        run_IntegerQuery(Integer_filterR, DoubleParameter, Double.valueOf(43), new Integer(43), 10);
        ...
        run_LongQuery(Long_filterL, longParameter, Long.valueOf(Long.MIN_VALUE), Long.valueOf(Long.MIN_VALUE), 9);
        run_LongQuery(Long_filterR, longParameter, Long.valueOf(Long.MAX_VALUE), Long.valueOf(Long.MAX_VALUE), 9);
        ...
        run_LongQuery(Long_filterL, ByteParameter, Byte.valueOf((byte)100), Long.valueOf(100), 8);
        run_LongQuery(Long_filterR, ByteParameter, Byte.valueOf((byte)0), Long.valueOf(0), 9);
        run_LongQuery(Long_filterL, shortParameter, Short.valueOf((short)-1000 ), Long.valueOf(-1000), 8);
        ...
        run_LongQuery(Long_filterL, CharacterParameter, Character.valueOf((char)23), Long.valueOf(23), 10);
        run_LongQuery(Long_filterR, CharacterParameter, Character.valueOf((char)0), Long.valueOf(0), 9);
        run_LongQuery(Long_filterL, intParameter, new Integer(100), Long.valueOf(100), 8);
        run_LongQuery(Long_filterR, intParameter, new Integer(0), Long.valueOf(0), 9);
        run_LongQuery(Long_filterL, IntegerParameter, new Integer(23), Long.valueOf(23), 10);
        run_LongQuery(Long_filterR, IntegerParameter, new Integer(1000000), Long.valueOf(1000000), 9);
        run_LongQuery(Long_filterL, floatParameter, Float.valueOf((float)-1000000.0), Long.valueOf(-1000000), 9);
//    run_LongQuery(Long_filterR, floatParameter, Float.valueOf((float)Long.MAX_VALUE), Long.valueOf(Long.MAX_VALUE), 9);
        ...
        run_LongQuery(Long_filterL, doubleParameter, Double.valueOf(-1000000.0), Long.valueOf(-1000000), 9);
//    run_LongQuery(Long_filterR, doubleParameter, Double.valueOf((double)Long.MAX_VALUE), Long.valueOf(Long.MAX_VALUE), 9);
        ...
        run_LongQuery(Long_filterL, BigIntegerParameter, new BigInteger("1000000"), Long.valueOf(1000000), 9);
        run_LongQuery(Long_filterR, BigIntegerParameter, new BigInteger("-1000000"), Long.valueOf(-1000000), 9);
        run_LongQuery(Long_filterL, BigDecimalParameter, new BigDecimal("-1000.0"), Long.valueOf(-1000), 8);
        run_LongQuery(Long_filterR, BigDecimalParameter, new BigDecimal("-1000000.0"), Long.valueOf(-1000000), 9);
        ...
        run_FloatQuery(Float_filterL, FloatParameter, Float.valueOf((float)0.0), Float.valueOf(0.0f), 9);
        run_FloatQuery(Float_filterR, FloatParameter, Float.valueOf((float)4.0), Float.valueOf(4.0f), 10);
        ...
        run_FloatQuery(Float_filterR, ByteParameter, Byte.valueOf((byte)100), Float.valueOf(100.0f), 8);
        run_FloatQuery(Float_filterL, shortParameter, Short.valueOf((short)0), Float.valueOf(0.0f), 9);
        run_FloatQuery(Float_filterR, shortParameter, Short.valueOf((short)23), Float.valueOf(23.0f), 10);
        run_FloatQuery(Float_filterL, ShortParameter, Short.valueOf((short)34), Float.valueOf(34.0f), 10);
        run_FloatQuery(Float_filterR, ShortParameter, Short.valueOf((short)100), Float.valueOf(100.0f), 8);
        run_FloatQuery(Float_filterL, charParameter, Character.valueOf((char)0), Float.valueOf(0.0f), 9);
        run_FloatQuery(Float_filterR, charParameter, Character.valueOf((char)23), Float.valueOf(23.0f), 10);
        run_FloatQuery(Float_filterL, CharacterParameter, Character.valueOf((char)34), Float.valueOf(34.0f), 10);
        run_FloatQuery(Float_filterR, CharacterParameter, Character.valueOf((char)100), Float.valueOf(100.0f), 8);
        run_FloatQuery(Float_filterL, intParameter, new Integer(50000000), Float.valueOf(50000000.0f), 9);
        run_FloatQuery(Float_filterR, intParameter, new Integer(23), Float.valueOf(23.0f), 10);
        run_FloatQuery(Float_filterL, IntegerParameter, new Integer(34), Float.valueOf(34.0f), 10);
        run_FloatQuery(Float_filterR, IntegerParameter, new Integer(100), Float.valueOf(100.0f), 8);
        run_FloatQuery(Float_filterL, longParameter, Long.valueOf(50000000), Float.valueOf(50000000.0f), 9);
        ...
        run_FloatQuery(Float_filterL, doubleParameter, Double.valueOf(50000000.0f), Float.valueOf(50000000.0f), 9);
        run_FloatQuery(Float_filterR, doubleParameter, Double.valueOf(100.0f), Float.valueOf(100.0f), 8);
        run_FloatQuery(Float_filterL, DoubleParameter, Double.valueOf(0.0f), Float.valueOf(0.0f), 9);
        run_FloatQuery(Float_filterR, DoubleParameter, Double.valueOf(100.0f), Float.valueOf(100.0f), 8);
        run_FloatQuery(Float_filterL, BigIntegerParameter, new BigInteger("50000000"), Float.valueOf(50000000.0f), 9);
        run_FloatQuery(Float_filterR, BigIntegerParameter, new BigInteger("1000000000"), Float.valueOf(1000000000.0f), 9);
        run_FloatQuery(Float_filterL, BigDecimalParameter, new BigDecimal("350.5"), Float.valueOf(350.5f), 9);
        run_FloatQuery(Float_filterR, BigDecimalParameter, new BigDecimal("50000000.0"), Float.valueOf(50000000.0f), 9);
        ...
        run_DoubleQuery(Double_filterL, doubleParameter, Double.valueOf(-25.5), Double.valueOf(-25.5), 9);
        run_DoubleQuery(Double_filterR, doubleParameter, Double.valueOf(-25.5), Double.valueOf(-25.5), 9);
        run_DoubleQuery(Double_filterL, DoubleParameter, Double.valueOf(0.0), Double.valueOf(0.0), 9);
        run_DoubleQuery(Double_filterR, DoubleParameter, Double.valueOf(23.34), Double.valueOf(23.34), 10);
        run_DoubleQuery(Double_filterL, byteParameter, Byte.valueOf((byte)100), Double.valueOf(100.0), 8);
        run_DoubleQuery(Double_filterR, byteParameter, Byte.valueOf((byte)0), Double.valueOf(0.0), 9);
        run_DoubleQuery(Double_filterL, ByteParameter, Byte.valueOf((byte)23), Double.valueOf(23.0), 10);
        run_DoubleQuery(Double_filterR, ByteParameter, Byte.valueOf((byte)100), Double.valueOf(100.0), 8);
        run_DoubleQuery(Double_filterL, shortParameter, Short.valueOf((short)100), Double.valueOf(100.0), 8);
        run_DoubleQuery(Double_filterR, shortParameter, Short.valueOf((short)0), Double.valueOf(0.0), 9);
        run_DoubleQuery(Double_filterL, ShortParameter, Short.valueOf((short)23), Double.valueOf(23.0), 10);
        run_DoubleQuery(Double_filterR, ShortParameter, Short.valueOf((short)100), Double.valueOf(100.0), 8);
        run_DoubleQuery(Double_filterL, charParameter, Character.valueOf((char)100), Double.valueOf(100.0), 8);
        run_DoubleQuery(Double_filterR, charParameter, Character.valueOf((char)0), Double.valueOf(0.0), 9);
        run_DoubleQuery(Double_filterL, CharacterParameter, Character.valueOf((char)23), Double.valueOf(23.0), 10);
        run_DoubleQuery(Double_filterR, CharacterParameter, Character.valueOf((char)100), Double.valueOf(100.0), 8);
        run_DoubleQuery(Double_filterL, intParameter, new Integer(100), Double.valueOf(100.0), 8);
        run_DoubleQuery(Double_filterR, intParameter, new Integer(0), Double.valueOf(0.0), 9);
        run_DoubleQuery(Double_filterL, IntegerParameter, new Integer(23), Double.valueOf(23.0), 10);
        run_DoubleQuery(Double_filterR, IntegerParameter, new Integer(100), Double.valueOf(100.0), 8);
        ...
        run_DoubleQuery(Double_filterR, floatParameter, Float.valueOf(100.0f), Double.valueOf(100.0), 8);
        run_DoubleQuery(Double_filterL, FloatParameter, Float.valueOf(100.0f), Double.valueOf(100.0), 8);
        run_DoubleQuery(Double_filterR, FloatParameter, Float.valueOf(69.96f), Double.valueOf(69.96), 10);
        run_DoubleQuery(Double_filterL, BigIntegerParameter, new BigInteger("50000000"), Double.valueOf(50000000.0f), 9);
        run_DoubleQuery(Double_filterR, BigIntegerParameter, new BigInteger("1000000000"), Double.valueOf(1000000000.0f), 9);
        run_DoubleQuery(Double_filterL, BigDecimalParameter, new BigDecimal("350.5"), Double.valueOf(350.5f), 9);
        run_DoubleQuery(Double_filterR, BigDecimalParameter, new BigDecimal("50000000.0"), Double.valueOf(50000000.0f), 9);
