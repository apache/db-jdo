...
public class NotEquals extends ComparisonTests {
  ...
  private void runQueries() {
    ...
    run_CharacterQuery(
        ...
        10);
    run_CharacterQuery(
        Character_filterL, FloatParameter, Float.valueOf((float) 'z'), Character.valueOf('z'), 8);
    run_CharacterQuery(
        Character_filterR, FloatParameter, Float.valueOf((float) 'z'), Character.valueOf('z'), 8);
    run_CharacterQuery(
