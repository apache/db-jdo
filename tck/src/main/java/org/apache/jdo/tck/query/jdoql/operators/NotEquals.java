...
//    run_longQuery(long_filterR, doubleParameter, new Double((double)Long.MAX_VALUE), Long.MAX_VALUE, 9);
        ...
        run_ShortQuery(Short_filterL, charParameter, Character.valueOf((char)75), new Short((short)75), 10);
        run_ShortQuery(Short_filterR, charParameter, Character.valueOf((char)75), new Short((short)75), 10);
        run_ShortQuery(Short_filterL, CharacterParameter, Character.valueOf((char)100), new Short((short)100), 8);
        run_ShortQuery(Short_filterR, CharacterParameter, Character.valueOf((char)100), new Short((short)100), 8);
        ...
        run_CharacterQuery(Character_filterL, shortParameter, new Short((short)'M'), Character.valueOf('M'), 8);
        run_CharacterQuery(Character_filterR, shortParameter, new Short((short)'F'), Character.valueOf('F'), 9);
        run_CharacterQuery(Character_filterL, ShortParameter, new Short((short)'A'), Character.valueOf('A'), 9);
        run_CharacterQuery(Character_filterR, ShortParameter, new Short((short)'A'), Character.valueOf('A'), 9);
        ...
        run_CharacterQuery(Character_filterL, longParameter, new Long('z'), Character.valueOf('z'), 8);
        run_CharacterQuery(Character_filterR, longParameter, new Long('z'), Character.valueOf('z'), 8);
        run_CharacterQuery(Character_filterL, LongParameter, new Long('B'), Character.valueOf('B'), 9);
        run_CharacterQuery(Character_filterR, LongParameter, new Long('B'), Character.valueOf('B'), 9);
        run_CharacterQuery(Character_filterL, floatParameter, new Float(123.222), Character.valueOf('x'), 10);
        run_CharacterQuery(Character_filterR, floatParameter, new Float(123.222), Character.valueOf('x'), 10);
        run_CharacterQuery(Character_filterL, FloatParameter, new Float('z'), Character.valueOf('z'), 8);
        run_CharacterQuery(Character_filterR, FloatParameter, new Float('z'), Character.valueOf('z'), 8);
        run_CharacterQuery(Character_filterL, doubleParameter, new Double('B'), Character.valueOf('B'), 9);
        run_CharacterQuery(Character_filterR, doubleParameter, new Double('B'), Character.valueOf('B'), 9);
        run_CharacterQuery(Character_filterL, DoubleParameter, new Double('A'), Character.valueOf('A'), 9);
        run_CharacterQuery(Character_filterR, DoubleParameter, new Double('A'), Character.valueOf('A'), 9);
        ...
        run_LongQuery(Long_filterL, charParameter, Character.valueOf((char)0), new Long(0), 9);
        run_LongQuery(Long_filterR, charParameter, Character.valueOf((char)100), new Long(100), 8);
        run_LongQuery(Long_filterL, CharacterParameter, Character.valueOf((char)23), new Long(23), 10);
        run_LongQuery(Long_filterR, CharacterParameter, Character.valueOf((char)0), new Long(0), 9);
...
//    run_LongQuery(Long_filterR, doubleParameter, new Double((double)Long.MAX_VALUE), new Long(Long.MAX_VALUE), 9);
        ...
        run_FloatQuery(Float_filterL, charParameter, Character.valueOf((char)0), new Float(0.0f), 9);
        run_FloatQuery(Float_filterR, charParameter, Character.valueOf((char)23), new Float(23.0f), 10);
        run_FloatQuery(Float_filterL, CharacterParameter, Character.valueOf((char)34), new Float(34.0f), 10);
        run_FloatQuery(Float_filterR, CharacterParameter, Character.valueOf((char)100), new Float(100.0f), 8);
        ...
        run_DoubleQuery(Double_filterL, charParameter, Character.valueOf((char)100), new Double(100.0), 8);
        run_DoubleQuery(Double_filterR, charParameter, Character.valueOf((char)0), new Double(0.0), 9);
        run_DoubleQuery(Double_filterL, CharacterParameter, Character.valueOf((char)23), new Double(23.0), 10);
        run_DoubleQuery(Double_filterR, CharacterParameter, Character.valueOf((char)100), new Double(100.0), 8);
