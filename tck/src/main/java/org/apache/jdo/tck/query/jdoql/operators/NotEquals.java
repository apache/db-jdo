...
//    run_longQuery(long_filterR, doubleParameter, Double.valueOf((double)Long.MAX_VALUE), Long.MAX_VALUE, 9);
        ...
        run_ByteQuery(Byte_filterL, shortParameter, Short.valueOf((short)50), new Byte((byte)50), 8);
        run_ByteQuery(Byte_filterR, shortParameter, Short.valueOf((short)50), new Byte((byte)50), 8);
        run_ByteQuery(Byte_filterL, ShortParameter, Short.valueOf((short)-100), new Byte((byte)-100), 9);
        run_ByteQuery(Byte_filterR, ShortParameter, Short.valueOf((short)-100), new Byte((byte)-100), 9);
        run_ByteQuery(Byte_filterL, charParameter, Character.valueOf((char)50), new Byte((byte)50), 8);
        run_ByteQuery(Byte_filterR, charParameter, Character.valueOf((char)50), new Byte((byte)50), 8);
        run_ByteQuery(Byte_filterL, CharacterParameter, Character.valueOf((char)50), new Byte((byte)50), 8);
        run_ByteQuery(Byte_filterR, CharacterParameter, Character.valueOf((char)75), new Byte((byte)75), 9);
        ...
        run_ByteQuery(Byte_filterL, longParameter, Long.valueOf(50), new Byte((byte)50), 8);
        run_ByteQuery(Byte_filterR, longParameter, Long.valueOf(50), new Byte((byte)50), 8);
        run_ByteQuery(Byte_filterL, LongParameter, Long.valueOf(-100), new Byte((byte)-100), 9);
        run_ByteQuery(Byte_filterR, LongParameter, Long.valueOf(-100), new Byte((byte)-100), 9);
        run_ByteQuery(Byte_filterL, floatParameter, Float.valueOf((float)50), new Byte((byte)50), 8);
        run_ByteQuery(Byte_filterR, floatParameter, Float.valueOf((float)50), new Byte((byte)50), 8);
        run_ByteQuery(Byte_filterL, FloatParameter, Float.valueOf((float)-100), new Byte((byte)-100), 9);
        run_ByteQuery(Byte_filterR, FloatParameter, Float.valueOf((float)-100), new Byte((byte)-100), 9);
        run_ByteQuery(Byte_filterL, doubleParameter, Double.valueOf(50), new Byte((byte)50), 8);
        run_ByteQuery(Byte_filterR, doubleParameter, Double.valueOf(50), new Byte((byte)50), 8);
        run_ByteQuery(Byte_filterL, DoubleParameter, Double.valueOf(-100), new Byte((byte)-100), 9);
        run_ByteQuery(Byte_filterR, DoubleParameter, Double.valueOf(-100), new Byte((byte)-100), 9);
        ...
        run_ShortQuery(Short_filterL, byteParameter, new Byte((byte)75), Short.valueOf((short)75), 10);
        run_ShortQuery(Short_filterR, byteParameter, new Byte((byte)75), Short.valueOf((short)75), 10);
        run_ShortQuery(Short_filterL, ByteParameter, new Byte((byte)100), Short.valueOf((short)100), 8);
        run_ShortQuery(Short_filterR, ByteParameter, new Byte((byte)100), Short.valueOf((short)100), 8);
        ...
        run_CharacterQuery(Character_filterL, byteParameter, new Byte((byte)Character.MIN_VALUE), Character.valueOf((char)Character.MIN_VALUE), 9);
        run_CharacterQuery(Character_filterR, ByteParameter, new Byte((byte)'a'), Character.valueOf('a'), 10);
        ...
        run_LongQuery(Long_filterL, byteParameter, new Byte((byte)100), Long.valueOf(100), 8);
        run_LongQuery(Long_filterR, byteParameter, new Byte((byte)0), Long.valueOf(0), 9);
        run_LongQuery(Long_filterL, ByteParameter, new Byte((byte)100), Long.valueOf(100), 8);
        run_LongQuery(Long_filterR, ByteParameter, new Byte((byte)0), Long.valueOf(0), 9);
...
//    run_LongQuery(Long_filterR, doubleParameter, Double.valueOf((double)Long.MAX_VALUE), Long.valueOf(Long.MAX_VALUE), 9);
        ...
        run_FloatQuery(Float_filterL, byteParameter, new Byte((byte)0), Float.valueOf(0.0f), 9);
        run_FloatQuery(Float_filterR, byteParameter, new Byte((byte)23), Float.valueOf(23.0f), 10);
        run_FloatQuery(Float_filterL, ByteParameter, new Byte((byte)34), Float.valueOf(34.0f), 10);
        run_FloatQuery(Float_filterR, ByteParameter, new Byte((byte)100), Float.valueOf(100.0f), 8);
        ...
        run_DoubleQuery(Double_filterL, byteParameter, new Byte((byte)100), Double.valueOf(100.0), 8);
        run_DoubleQuery(Double_filterR, byteParameter, new Byte((byte)0), Double.valueOf(0.0), 9);
        run_DoubleQuery(Double_filterL, ByteParameter, new Byte((byte)23), Double.valueOf(23.0), 10);
        run_DoubleQuery(Double_filterR, ByteParameter, new Byte((byte)100), Double.valueOf(100.0), 8);
