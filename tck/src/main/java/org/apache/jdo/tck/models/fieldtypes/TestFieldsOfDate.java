...
/**
 * <B>Title:</B> Support of field type Date. <br>
 * <B>Keywords:</B> model <br>
 * <B>Assertion ID:</B> A6.4.3-21. <br>
 * <B>Assertion Description: </B> JDO implementations must support fields of the mutable object
 * class <code>java.util.Date</code>, and may choose to support them as Second Class Objects or
 * First Class Objects.
 */
