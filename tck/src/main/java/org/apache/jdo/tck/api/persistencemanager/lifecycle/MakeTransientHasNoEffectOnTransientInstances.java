 ...
 * <B>Assertion IDs:</B> A12.5.7-19 <br>
 * <B>Assertion Description: </B> PersistenceManager.makeTransient and makeTransientAll have no
 * effect if the parameter instance is transient.
 */
public class MakeTransientHasNoEffectOnTransientInstances extends PersistenceManagerTest {
  ...
  private void runTestMakeTransientHasNoEffectOnTransientInstances1(PersistenceManager pm) {
  ...
  private void runTestMakeTransientHasNoEffectOnTransientInstancesAll2(PersistenceManager pm) {
    Transaction tx = pm.currentTransaction();
    try {
      tx.begin();
