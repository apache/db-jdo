...
public class FetchGroupTest extends JDO_Test {
  ...
  protected String[] relationshipMembers =
      new String[] {
        "dentalInsurance",
        "medicalInsurance",
        "department",
  ...
  protected String[] multivaluedMembers =
      new String[] {"reviewedProjects", "projects", "team", "hradvisees", "phoneNumbers"};

  protected String[] allButMultivaluedMembers =
      new String[] {
        "hiredate",
        "weeklyhours",
        "dentalInsurance",
