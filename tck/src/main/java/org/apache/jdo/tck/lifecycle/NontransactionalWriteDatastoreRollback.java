 ...
 * <B>Keywords:</B> NontransactionalWrite datastore rollback <br>
 ...
 * RestoreValues flag. ]
 */
public class NontransactionalWriteDatastoreRollback extends NontransactionalWriteTest {
  ...
  public void testDatastoreRollback() {
    ...
    checkXValue(ASSERTION_FAILED + "after datastore rollback", ORIGINAL_XVALUE);
    failOnError();
  }
}
