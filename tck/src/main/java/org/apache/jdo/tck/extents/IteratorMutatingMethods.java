...
/**
 * <B>Title:</B> Iterator Mutating Methods <br>
 * <B>Keywords:</B> extent exception <br>
 * <B>Assertion ID:</B> A15.3-4. <br>
 * <B>Assertion Description: </B> If any mutating method, including the <code>remove</code> method,
 * is called on the <code>Iterator</code> returned by <code>Extent.iterator()</code>, an <code>
