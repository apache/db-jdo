...
public class StubPMF implements PersistenceManagerFactory {
  ...
  void setProperty(String name, Object value) {
    ...
    if (name.equals(JDOConstants.PROPERTY_PERSISTENCE_MANAGER_FACTORY_CLASS)) {
      setPersistenceManagerFactoryClass(val);
      return;
    }
    if (name.equals(JDOConstants.PROPERTY_CONNECTION_DRIVER_NAME)) {
      setConnectionDriverName(val);
      return;
    }
    if (name.equals(JDOConstants.PROPERTY_CONNECTION_FACTORY_NAME)) {
      setConnectionFactoryName(val);
      return;
    }
    if (name.equals(JDOConstants.PROPERTY_CONNECTION_FACTORY2_NAME)) {
      setConnectionFactory2Name(val);
      return;
    }
    if (name.equals(JDOConstants.PROPERTY_CONNECTION_PASSWORD)) {
      setConnectionPassword(val);
      return;
    }
    if (name.equals(JDOConstants.PROPERTY_CONNECTION_URL)) {
      setConnectionURL(val);
      return;
    }
    if (name.equals(JDOConstants.PROPERTY_CONNECTION_USER_NAME)) {
      setConnectionUserName(val);
      return;
    }
    if (name.equals(JDOConstants.PROPERTY_IGNORE_CACHE)) {
      setCopyOnAttach(Boolean.parseBoolean(val));
      return;
    }
    if (name.equals(JDOConstants.PROPERTY_DATASTORE_READ_TIMEOUT_MILLIS)) {
      setDatastoreReadTimeoutMillis(Integer.parseInt(val));
      return;
    }
    if (name.equals(JDOConstants.PROPERTY_DATASTORE_WRITE_TIMEOUT_MILLIS)) {
      setDatastoreWriteTimeoutMillis(Integer.parseInt(val));
      return;
    }
    if (name.equals(JDOConstants.PROPERTY_DETACH_ALL_ON_COMMIT)) {
    ...
    if (name.equals(JDOConstants.PROPERTY_MAPPING)) {
      setMapping(val);
      return;
    }
    if (name.equals(JDOConstants.PROPERTY_MULTITHREADED)) {
      setMultithreaded(Boolean.parseBoolean(val));
      return;
    }
    if (name.equals(JDOConstants.PROPERTY_NAME)) {
      setName(val);
      return;
    }
    if (name.equals(JDOConstants.PROPERTY_NONTRANSACTIONAL_READ)) {
      setNontransactionalRead(Boolean.parseBoolean(val));
      return;
    }
    if (name.equals(JDOConstants.PROPERTY_NONTRANSACTIONAL_WRITE)) {
      setNontransactionalWrite(Boolean.parseBoolean(val));
      return;
    }
    if (name.equals(JDOConstants.PROPERTY_OPTIMISTIC)) {
      setOptimistic(Boolean.parseBoolean(val));
      return;
    }
    if (name.equals(JDOConstants.PROPERTY_PERSISTENCE_UNIT_NAME)) {
      setPersistenceUnitName(val);
      return;
    }
    if (name.equals(JDOConstants.PROPERTY_READONLY)) {
      setReadOnly(Boolean.parseBoolean(val));
      return;
    }
    if (name.equals(JDOConstants.PROPERTY_RESTORE_VALUES)) {
      setRestoreValues(Boolean.parseBoolean(val));
      return;
    }
    if (name.equals(JDOConstants.PROPERTY_RETAIN_VALUES)) {
      setRetainValues(Boolean.parseBoolean(val));
      return;
    }
    if (name.equals(JDOConstants.PROPERTY_SERVER_TIME_ZONE_ID)) {
      setServerTimeZoneID(val);
      return;
    }
    if (name.equals(JDOConstants.PROPERTY_TRANSACTION_ISOLATION_LEVEL)) {
      setTransactionIsolationLevel(val);
      return;
    }
    if (name.equals(JDOConstants.PROPERTY_TRANSACTION_TYPE)) {
      setTransactionType(val);
      return;
    }
    if (name.equals(JDOConstants.PROPERTY_SPI_RESOURCE_NAME)) {
