...
public class EnhancerTest extends AbstractTest {
  ...
  public void testInvalidOption() {
    ...
    assertEquals("Wrong return value ", JDOConstants.ENHANCER_USAGE_ERROR, result.getExitValue());
    String errorString = result.getErrorString();
    assertTrue(
  ...
  public void testProperties() {
    ...
    assertTrue(
        "Expected MockEnhancer vendor message from out:\n"
            ...
            + " with err:\n"
            + errorString,
        outputString.contains(JDOConstants.PROPERTY_ENHANCER_VENDOR_NAME));
    assertTrue(
        "Expected MockEnhancer version message from out:\n"
            + outputString
            + " with err:\n"
            + errorString,
        outputString.contains(JDOConstants.PROPERTY_ENHANCER_VERSION_NUMBER));
    assertTrue(
        "Expected MockEnhancer vendor message from out:\n"
            + outputString
            + " with err:\n"
