...
/**
 * Annotation for the element of a collection/array relation. Corresponds to the xml element
 * "element".
 *
 * @version 2.1
 * @since 2.1
...
public @interface Element {
  /**
   * Types of the elements. This can be determined if using JDK1.5 generics but is required
   * otherwise. Multiple types can be specified if the implementation supports multiple types.
   *
   ...
   *
   * @return whether the element is to be stored serialized (into a join table)
   */
   ...
   *
   * @return whether the element is dependent on the owner, and will be deleted when the owner is
   *     deleted
   */
  ...
  /**
   * Name of the member in the target class that forms a bidirectional relationship with this
   * member.
   *
   * @return name of the member in the target class that forms a bidirectional relationship with
   *     this member
   */
