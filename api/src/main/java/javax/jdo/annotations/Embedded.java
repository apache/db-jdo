...
/**
 * Annotation to define that the object is embedded into the table of the owning object. Corresponds
 * to the xml element "embedded".
 *
 * @version 2.1
 * @since 2.1
 */
...
public @interface Embedded {
  /**
   * The member in the embedded object that links back to the owning object where it has a
