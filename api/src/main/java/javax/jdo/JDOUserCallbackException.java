...
/**
 * This class represents exceptions caused by exceptions thrown during execution of callbacks or
 * listeners.
 *
 * @version 2.0
 */
public class JDOUserCallbackException extends JDOUserException {
  ...
  /** Constructs a new <code>JDOUserCallbackException</code> without a detail message. */
  ...
  /**
   * Constructs a new <code>JDOUserCallbackException</code> with the specified detail message and
  ...
  /**
   * Constructs a new <code>JDOUserException</code> with the specified detail message, nested <code>
