...
public interface MemberMetadata extends Metadata {
  ...
  /**
   * Method to set the field type(s). For defining where we want to restrict what type is stored in
   * a field
   *
  ...
  /**
   * Accessor for whether any AttributeConverter for this member type is explicitly disabled and
   * should use the implementation default.
   *
   * @return Whether it is explicitly disabled
   */
