...
public class JDOConstants {
   ...
   * @since 3.1
   */
  public static final String JAVAX_JDO = "javax.jdo";

  /** The JDO standard property string and option string prefix. */
  public static final String JAVAX_JDO_PREFIX = JAVAX_JDO + ".";
   ...
   * @since 2.1
   */
  public static final String SERVICE_LOOKUP_PMF_RESOURCE_NAME =
   ...
   * @since 2.1
   */
  public static final String JDOCONFIG_XSD_NS = "https://db.apache.org/jdo/xmlns/jdoconfig";
   ...
   * @since 2.1
   */
  public static final String JDO_XSD_NS = "https://db.apache.org/jdo/xmlns/jdo";
   ...
   * @since 2.1
   */
  public static final String ORM_XSD_NS = "https://db.apache.org/jdo/xmlns/orm";
   ...
   * @since 2.1
   */
  public static final String JDOQUERY_XSD_NS = "https://db.apache.org/jdo/xmlns/jdoquery";
   ...
   * @since 2.1
   */
  public static final String OPTION_UNCONSTRAINED_QUERY_VARIABLES =
      "javax.jdo.query.JDOQL.UnconstrainedQueryVariables";
   ...
   * @since 2.1
   */
  public static final String OPTION_MAPPING_HETEROGENEOUS_OBJECT_TYPE =
      "javax.jdo.option.mapping.HeterogeneousObjectType";
  /**
   ...
   * @since 2.1
   */
  public static final String OPTION_MAPPING_HETEROGENEOUS_INTERFACE_TYPE =
      "javax.jdo.option.mapping.HeterogeneousInterfaceType";
  /**
   ...
   * @since 2.1
   */
  public static final String OPTION_MAPPING_JOINED_TABLE_PER_CLASS =
      "javax.jdo.option.mapping.JoinedTablePerClass";
  /**
   ...
   * @since 2.1
   */
  public static final String OPTION_MAPPING_JOINED_TABLE_PER_CONCRETE_CLASS =
      "javax.jdo.option.mapping.JoinedTablePerConcreteClass";
  /**
   ...
   * @since 2.1
   */
  public static final String OPTION_MAPPING_NON_JOINED_TABLE_PER_CONCRETE_CLASS =
      "javax.jdo.option.mapping.NonJoinedTablePerConcreteClass";
  /**
   ...
   * @since 2.1
   */
  public static final String OPTION_MAPPING_RELATION_SUBCLASS_TABLE =
      "javax.jdo.option.mapping.RelationSubclassTable";
   ...
   * @since 2.1
   */
  public static final String PROPERTY_PERSISTENCE_MANAGER_FACTORY_CLASS =
      "javax.jdo.PersistenceManagerFactoryClass";
   ...
   * @since 2.2
   */
  public static final String PROPERTY_TRANSACTION_ISOLATION_LEVEL_READ_UNCOMMITTED =
      "javax.jdo.option.TransactionIsolationLevel.read-uncommitted";
  /**
   ...
   * @since 2.2
   */
  public static final String PROPERTY_TRANSACTION_ISOLATION_LEVEL_READ_COMMITTED =
      "javax.jdo.option.TransactionIsolationLevel.read-committed";
  /**
   ...
   * @since 2.2
   */
  public static final String PROPERTY_TRANSACTION_ISOLATION_LEVEL_REPEATABLE_READ =
      "javax.jdo.option.TransactionIsolationLevel.repeatable-read";
  /**
   ...
   * @since 2.2
   */
  public static final String PROPERTY_TRANSACTION_ISOLATION_LEVEL_SNAPSHOT =
      "javax.jdo.option.TransactionIsolationLevel.snapshot";
  /**
   ...
   * @since 2.2
   */
  public static final String PROPERTY_TRANSACTION_ISOLATION_LEVEL_SERIALIZABLE =
      "javax.jdo.option.TransactionIsolationLevel.serializable";
  /**
   ...
   * @since 3.2
   */
  public static final String PROPERTY_SPI_PROPERTIES_FILE_NAME = "javax.jdo.spi.PropertiesFileName";
   ...
   */
  public static final String PROPERTY_INSTANCE_LIFECYCLE_LISTENER =
      "javax.jdo.listener.InstanceLifecycleListener";
   ...
   * @since 2.1
   */
  public static final String PROPERTY_PREFIX_INSTANCE_LIFECYCLE_LISTENER =
   ...
   * @since 3.0
   */
  public static final String PROPERTY_DATASTORE_READ_TIMEOUT_MILLIS =
   ...
   * @since 3.0
   */
  public static final String PROPERTY_DATASTORE_WRITE_TIMEOUT_MILLIS =
