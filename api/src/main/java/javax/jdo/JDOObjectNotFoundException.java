...
/**
 * This class represents exceptions caused by the user accessing an object that does not exist in
 * the datastore.
 *
 * @since 1.0.1
 * @version 1.0.1
...
public class JDOObjectNotFoundException extends JDODataStoreException {
  ...
  /**
   * Constructs a new <code>JDOObjectNotFoundException</code> with the specified detail message and
   * failed object.
   *
   * @param msg the detail message.
