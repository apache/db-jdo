...
/**
 * A <code>RegisterClassEvent</code> event gets delivered whenever a persistence-capable class
 * registers itself with the <code>JDOImplHelper</code>.
 *
 * @version 1.0
 */
