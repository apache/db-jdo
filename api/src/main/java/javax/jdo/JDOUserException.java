...
public class JDOUserException extends JDOCanRetryException {
  ...
  /**
   * Constructs a new <code>JDOUserException</code> with the specified detail message and nested
  ...
  /**
   * Constructs a new <code>JDOUserException</code> with the specified detail message and failed
   * object.
   *
   * @param msg the detail message.
