...
/**
 *<B>Title:</B> Calling Jdo Preclear
 *<BR>
 *<B>Keywords:</B> instancecallbacks
 *<BR>
 *<B>Assertion ID:</B> A10.3-1.
 *<BR>
 *<B>Assertion Description: </B>
The <code>jdoPreClear()</code> method of a class implementing
<code>InstanceCallbacks</code> is called before the values in the instance
are cleared. (This happens during the state transition to hollow.)
...
public class CallingJdoPreclear extends TestParts {
    ...
    private static final String ASSERTION_FAILED = 
        "Assertion A10.3-1 (CallingJdoPreclear) failed";
